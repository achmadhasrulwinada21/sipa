...
class ttd extends CI_Controller {
    ...
    public function index()
    {
        $data = array(
            ...
            'data_ttd' => $this->model->GetTtd("order by idttd desc")->result_array(),
        );

        $this->template->Display('ttd/data_ttd', $data);
    }
    ...
    function addttd()
    {
        ...
        $this->template->Display('ttd/add_ttd', $data);
    }
    ...
    function editttd($kode=0){
        ...
        $this->template->Display('ttd/edit_ttd', $data);
