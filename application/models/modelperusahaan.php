...
class modelperusahaan extends CI_Model {
	...
	function update_perusahaan($data){
    	...
    	$this->db->update('master_perusahaan',$data);
	...
	{
		$this->db->insert('master_perusahaan', $data);
	}
	...
	{
            $this->db->select('Right(master_perusahaan.koper, 4) as kode ',false);
	...
	{
		$datas = $this->db->query('select * from master_perusahaan ');
		return $datas;
	}
