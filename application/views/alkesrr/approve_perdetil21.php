...
<ul class="nav nav-tabs">
        ...
        <div class="row-fluid">
                ...
                <div class="box-title"><br> 
                 ...
                 <form role="form" form name="form2" action="<?php echo site_url('Alkesrr/update_appdetil') ?>" method="post" enctype="multipart/form-data">
               ...
               <table id="tb-datatables" class="table table-bordered table-striped table-hover" style="vertical-align: middle;width:100%;">
                  ...
                  <th  rowspan="2" style="vertical-align: middle;text-align: center;">Harga lama</th>
                   <th  rowspan="2"  style="vertical-align: middle;text-align: center;">disc lama(%)</th>
                   <th  rowspan="2"  style="vertical-align: middle;text-align: center;">ppn lama</th>
                    <th  rowspan="2" style="vertical-align: middle;text-align: center;">Harga Baru</th>
                   <th  rowspan="2" style="vertical-align: middle;text-align: center;">disc Baru(%)</th>
                   <th  rowspan="2" style="vertical-align: middle;text-align: center;">ppn Baru</th>
                    <th  rowspan="2" style="vertical-align: middle;text-align: center;">Catatan harga</th>
                     <th  rowspan="2"  style="vertical-align: middle;text-align: center;">Catatan diskon</th>
                     <th  rowspan="2"  style="vertical-align: middle;text-align: center;">Status</th>
                     <th rowspan="2" style="vertical-align: middle;text-align: center;">Catatan Approve</th>
                    <th colspan="3"  style="vertical-align: middle;text-align: center;">Aksi</th>
                  </tr>
                   <tr class="danger"><th style="text-align:center;width:10%">Approval
                 </th>
          ...
          <td style="vertical-align: middle;text-align: center;"><?php echo $tr['diskon_lama']; ?>
           ...
           <td style="vertical-align: middle;text-align: right;"><?php echo number_format($tr['ppn_lama']); ?>
             ...
             <td style="vertical-align: middle;text-align: right;">
                 <?php echo number_format($tr['harga_baru']); ?>
            </td>
   ...
   <p style="color:black;font-weight:bold;background-color:yellow;line-height:20px;"><?php echo $status; ?></p>
         ...
         <?php endif; ?>
           ...
           <a style="margin-bottom:3px;" target="blank" class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>Alkesrr/cetak_alkesproduk2/<?php echo $tr['iddetilalkesrr']; ?>" title="lihat Detail"><i class="fa fa-eye"></i></a> 
            <a target="blank" style="margin-bottom:3px;"  class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>Alkesrr/lihatongkir/<?php echo $tr['kode_produk']; ?>/<?php echo $tr['koper']; ?>" title="Lihat Ongkir"><i class="fa fa-eye"></i></a>
          </td>
        </tr>
            <?php  } ?> 
               </tbody></table>
