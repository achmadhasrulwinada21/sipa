					...
					<table border="1" cellspacing="0"  cellpadding="2">
                     ...
                     $html.=' <br><br>
                         <table border="0">
                            ...
                            <tr>
                             ...
                             <tr>
                              <td width="135px">Harga Baru</td>
                              <td width="20px">:</td>
                              <td>Rp. '.number_format($alkes->harga_baru).'<br></td>
                            </tr>
                             <tr>
                              <td width="135px">Diskon Baru (%)</td>
                              <td width="20px">:</td>
                              <td>'.$alkes->diskon_baru.'<br></td>
                            </tr>
                             <tr>
                              <td width="135px">Harga Akhir Baru</td>
                              <td width="20px">:</td>
                              <td>Rp. '.number_format($alkes->harga_akhir_baru).'<br></td>
                            </tr>
                            <tr>
                              <td width="135px">Nominal Fee Baru</td>
                              <td width="20px">:</td>
                              <td>Rp. '.number_format($alkes->nominal_fee_baru).',-<br></td>
                            </tr>
                             <tr>
                              <td width="135px">Harga Lama</td>
                              <td width="20px">:</td>
                              <td>Rp. '.number_format($alkes->harga_lama).'<br></td>
                            </tr>
                             <tr>
                              <td width="135px">Diskon Lama (%)</td>
                              <td width="20px">:</td>
                              <td>'.$alkes->diskon_lama.'<br></td>
                            </tr>
                             <tr>
                              <td width="135px">Harga Akhir Lama</td>
                              <td width="20px">:</td>
                              <td>Rp. '.number_format($alkes->harga_akhir_lama).'<br></td>
                            </tr>
                              <tr>
                              <td width="135px">Nominal Fee Lama</td>
                              <td width="20px">:</td>
                              <td>Rp. '.number_format($alkes->nominal_fee_lama).',-<br></td>
                            </tr>
                              <tr>
                     ...
                     $html.=' 
                            ...
                            <tr  align="center" style="line-height:15px;font-weight:bold;" bgcolor="skyblue">
                                 <th colspan="3">Garansi</th>
                              </tr>
                               <tr  align="center" style="line-height:15px;font-weight:bold;" bgcolor="skyblue">
                                 <th colspan="3">Kontrak Servis</th>
                              </tr>
                              <tr align="center" style="line-height:15px;font-weight:bold;" bgcolor="skyblue">
                              ...
                              <tr>
                                ...
                                <td align="center" style="line-height:15px;">
                                <b>Rp. '.number_format($alkes->nominal_lama1).',-</b><br>
                                <b>Rp. '.number_format($alkes->nominal_lama2).',-</b><br>
                                <b>Rp. '.number_format($alkes->nominal_lama3).',-</b><br>
                                <b>Rp. '.number_format($alkes->nominal_lama4).',-</b><br>
                                <b>Rp. '.number_format($alkes->nominal_lama5).',-</b>
                                </td>
                                <td align="center" style="line-height:15px;">
