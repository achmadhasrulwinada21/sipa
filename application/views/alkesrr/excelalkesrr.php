...
<?php
          ...
          $cetak_alkes = $this->malkesrr->Getalkesdetilview("where kode_transaksi='$kode_transaksi' and stsapp_detil='Disetujui Direktur Ops & Umum' and statuslist_detil='live' and stsproduk_detil='aktif'")->result_array();
?>
           <table>     
           <?php        
