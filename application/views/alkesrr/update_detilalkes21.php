...
<ul class="nav nav-tabs">
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                  <form role="form" form name="form2" action="<?php echo site_url('Alkesrr/update_hargalama2') ?>" method="post" enctype="multipart/form-data">
                <div class="item">                   
                 <div class="row-fluid">
                  <dl class="dl-horizontal">
                          ...
                          <dt>Fee Management :</dt>
                            <dd> <input type="radio" value="1" name="jenis_pembayaran21"<?php echo $c1=$prod->jenis_pembayaran; if($c1=='1') echo " checked "?> >CASH<br>
                     <input type="radio" value="0" name="jenis_pembayaran21"<?php echo $c1=$prod->jenis_pembayaran; if($c1=='0') echo " checked "?> >SPONSORSHIP</dd></dd>
                           </dl>
              <div class="well">
             ...
             <?php echo $tr['ppn_baru']; ?>
              <?php endif; ?>
                ...
                <input type="hidden" class="form-control" value="<?php echo $tr['tahunke5']; ?>" id="" name="tahunke5[]"> 
                 <input type="hidden" class="form-control" value="<?php echo $tr['fee']; ?>" id="" name="fee[]">  <input type="hidden" class="form-control" value="<?php echo $tr['jenis_pembayaran']; ?>" id="" name="jenis_pembayaran[]">                              
            ...
            <div class='row'>
                  ...
                  <div class='col-sm-2' style="margin-left:80%;">
                    <button  type='submit' class='btn btn-success btn-plat btn-block btn-md' id='Simpann'>
                      <i class='fa fa-floppy-o'></i> Update Data
                    </button>
                   </div>
                </div>
          </div>
