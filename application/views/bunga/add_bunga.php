              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                   <span id="pesan-error-flash"><?php echo $this->session->flashdata('alert'); ?>
                    ...
                    <form role="form" action="<?php echo base_url(); ?>Bunga/savedata" method="POST" enctype="multipart/form-data">
                  <div class="col-lg-12">
                  ...
                  <div class="form-group">
                      <label for="">Bunga</label>
                        <input type="text" class="form-control" value="" id="" name="bunga" placeholder="Isi bunga contoh 9,25" required>                        
                    </div>
                    ...
                    <div class="form-group">
                      <input type="hidden" class="form-control" value="0" id="" name="pinjaman" placeholder="Isi Pinjaman">                        
                    </div> 
                ...
                <div class="form-group">
                  <button onclick="return confirm('Apakah Data Detail Sudah Terisi ?... ');" type="submit" class="btn btn-primary btn-block btn-flat">Simpan</button>
