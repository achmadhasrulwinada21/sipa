<section class="content-header">
  ...
  <ul class="nav navbar-nav">
     ...
     <li class="active" style="border:none; outline: none; cursor:pointer;background-color:#F0F8FF;"><a href="<?php echo base_url(); ?>Pinjaman">PINJAMAN</a></li>           
          ...
          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Pinjaman/direvisidirut" class="btn btn-success no-radius dropdown-toggle"><i class="glyphicon glyphicon-retweet"></i> &nbsp DIREVISI DIRUT</a>

          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Pinjaman/direvisi" class="btn btn-primary no-radius dropdown-toggle"><i class="glyphicon glyphicon-retweet"></i> &nbsp DIREVISI DIREKTUR</a>

          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Pinjaman/direvisikadep" class="btn btn-danger no-radius dropdown-toggle"><i class="glyphicon glyphicon-retweet"></i> &nbsp DIREVISI KADEP</a>
