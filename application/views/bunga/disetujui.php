<section class="content-header">
  ...
  <ul class="nav navbar-nav">
    ...
    <li class="active" style="border:none; outline: none; cursor:pointer;background-color:#F0F8FF;"><a href="<?php echo base_url(); ?>Pinjaman">PINJAMAN</a></li>           
          ...
          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Pinjaman/disetujuidirut" class="btn btn-success no-radius dropdown-toggle"><i class="glyphicon glyphicon-ok"></i> &nbsp DISETUJUI DIRUT</a>

          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Pinjaman/disetujui" class="btn btn-primary no-radius dropdown-toggle"><i class="glyphicon glyphicon-ok"></i> &nbsp DISETUJUI DIREKTUR</a>

          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Pinjaman/disetujuikadep" class="btn btn-danger no-radius dropdown-toggle"><i class="glyphicon glyphicon-ok"></i> &nbsp DISETUJUI KADEP</a>
