  ...
  <ul class="nav navbar-nav">
   <li class="active" style="border:none; outline: none; cursor:pointer;background-color:#F0F8FF;"><a href="<?php echo base_url(); ?>Bunga"">BUNGA</a></li>
    <li style="border:none; outline: none; cursor:pointer;background-color:#F0F8FF;"><a href="<?php echo base_url(); ?>Pinjaman">PINJAMAN</a></li>           
          ...
          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Bunga/disetujui" class="btn btn-primary no-radius dropdown-toggle"><i class="glyphicon glyphicon-ok"></i> &nbsp DISETUJUI DIREKTUR</a>

          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Bunga/disetujuikadep" class="btn btn-danger no-radius dropdown-toggle"><i class="glyphicon glyphicon-ok"></i> &nbsp DISETUJUI KADEP</a>
