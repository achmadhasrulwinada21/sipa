<section class="content-header">
  ...
  <ul class="nav navbar-nav">
     ...
     <li class="active" style="border:none; outline: none; cursor:pointer;background-color:#F0F8FF;"><a href="<?php echo base_url(); ?>Pinjaman">PINJAMAN</a></li>           
          ...
          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Pinjaman/ditolakdirut" class="btn btn-success no-radius dropdown-toggle"><i class="glyphicon glyphicon-remove"></i> &nbsp DITOLAK DIRUT</a>

          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Pinjaman/ditolak" class="btn btn-primary no-radius dropdown-toggle"><i class="glyphicon glyphicon-remove"></i> &nbsp DITOLAK DIREKTUR</a>

          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Pinjaman/ditolakkadep" class="btn btn-danger no-radius dropdown-toggle"><i class="glyphicon glyphicon-remove"></i> &nbsp DITOLAK KADEP</a>
