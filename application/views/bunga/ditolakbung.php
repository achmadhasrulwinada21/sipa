<section class="content-header">
  ...
  <ul class="nav navbar-nav">
    ...
    <li style="border:none; outline: none; cursor:pointer;background-color:#F0F8FF;"><a href="<?php echo base_url(); ?>Pinjaman">PINJAMAN</a></li>           
          ...
          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Bunga/ditolakdir" class="btn btn-primary no-radius dropdown-toggle"><i class="glyphicon glyphicon-remove"></i> &nbsp DITOLAK DIREKTUR</a>

          <a style="margin-bottom:3px;margin-left:5px;" href="<?php echo base_url(); ?>Bunga/ditolak" class="btn btn-danger no-radius dropdown-toggle"><i class="glyphicon glyphicon-remove"></i> &nbsp DITOLAK KADEP</a>
