          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                   <form role="form" action="<?php echo base_url(); ?>Pinjaman/updatepinjams" method="POST" enctype="multipart/form-data">
 ...
 -->
                    ...
                    <div class="form-group">
                      <label for="">Pinjaman</label>
                        <input type="text" class="form-control" value="<?php echo $pinjaman; ?>" id="" name="pinjaman" readonly>                        
                    </div>
            ...
            <?php endif;?>
					...
					<?php
             $uul=($this->session->userdata('koderole'));  
           if($uul=='10' AND $pinjaman !=0 AND $pinjaman < 1000000000):?>
          ...
          <?php
             $uul=($this->session->userdata('koderole'));  
           if($uul=='29' AND $pinjaman !=0 AND $pinjaman < 1000000000):?>
          ...
          <?php
             $uul=($this->session->userdata('koderole'));  
           if($uul=='28' AND $pinjaman !=0 AND $pinjaman < 1000000000):?>
          ...
          <?php
             $uul=($this->session->userdata('koderole'));  
           if($uul=='10' AND $pinjaman >= 1000000000):?>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <?php
             $uul=($this->session->userdata('koderole'));  
           if($uul=='28' AND $pinjaman >= 1000000000):?>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <?php
             $uul=($this->session->userdata('koderole'));  
           if($uul=='29' AND $pinjaman >= 1000000000):?>
          ...
          <div class="form-group">
             ...
             <a href="<?php echo base_url(); ?>email/kirim_email/<?php echo $id_sbunga; ?>" class="btn btn-danger btn-block btn-flat" target="blank">Konfirmasi Approve</a>
             ...
             <a href="<?php echo base_url(); ?>email/kirim_emaill/<?php echo $id_sbunga; ?>" class="btn btn-danger btn-block btn-flat" target="blank">Konfirmasi Approve</a>
               ...
               <!-- <input type="submit" formtarget="_blank" class="btn btn-success btn-block btn-flat" value="Email" name="kontak" onClick="form.action='../../email/kirim_emaill/<?php echo $id_sbunga; ?>?action=download';form.submit();">  -->
