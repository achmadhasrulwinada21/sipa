<?php
			...
			$pdf->SetTitle('Detail Database Prinsipal Farmasi');
	...
	// 		}
				...
				table thead 
			{
				display: table-header-group;
					...
					<thead>
						<tr>
						<td width="100%" align="center">DATABASE PRINSIPAL FARMASI<br></td></tr>
          	          </thead>
			...
			foreach ($cetak_compare_obat as $row) 
			{
				...
				$html.='
					...
					<tr>
						...
						<td width="10%" align="center" style="line-height:15px;">'.$row['mou_jkn'].'</td>
						<td width="10%" align="center" style="line-height:15px;">'.$row['pks_renewal'].'</td>
		...
		<b>PERSENTASE(%) :  </b><br><br>
					...
					<tr bgcolor="#ffffff" style="font-weight:bold;">
							<th width="25%" align="left">
								<p>(lebih kecil sama dengan E - Kat / lebih besar 10 % E Kat)*100%</p>
							...
							<th width="30%" align="left" style="line-height:10px;">
								...
								<p><span> = </span> '.number_format($persenb,1).' %</p>
			...
			$html.='<br><br><br><br>
					...
					<tr>
					 ...
					 $html.='   <td width="400"> </td>
					    <td width="200"  align="left" style="line-height:80px;"><img src="assets/upload/'.$prod->ttd_menyetujui.'" width="80px" height="50px"></td>
					</tr> </table>';
					...
					<table border="0">
						<tr>
						<td width="100" align="left"></td>
						<td width="200" align="left">dr. Endah Malahayati, MARS</td>
						<td width="400"> </td>
