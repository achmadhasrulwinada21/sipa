 ...
 ?>
   ...
   <tr style="font-weight:bold;" bgcolor="#A9A9A9">
    ...
    <tr>
      ...
      <td style="text-align:right;vertical-align:middle;"><?php echo $row['harga']; ?></td>
    <td style="text-align:center;vertical-align:middle;"><?php echo $row['discount']; ?></td> 
      <td style="text-align:center;vertical-align:middle;"><?php echo $row['idharga']; ?></td>
   ...
   <td style="text-align:justify;vertical-align:middle;"><?php echo $row['nama_obat']; ?></td>
    <td style="text-align:center;vertical-align:middle;"><?php echo $row['kode_th']; ?></td>  
