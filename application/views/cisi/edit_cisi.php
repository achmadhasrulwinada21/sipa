          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>cisi/updatecisi" method="POST" enctype="multipart/form-data">
                  <div class="col-lg-6">
                   ...
                   <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="">WAKTU</label>
                        <input type="text" class="form-control" value="<?php echo $waktu; ?>" id="" name="waktu">                        
                    </div>
                    <div class="form-group">
