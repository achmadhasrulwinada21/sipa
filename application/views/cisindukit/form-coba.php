          ...
          <div class="row">
            <div class="col-md-12">
			 <div class="box box-primary">
			  ...
			  class="btn btn-primary no-radius dropdown-toggle"><i class="glyphicon glyphicon-download-alt"></i> Download Format </a>
			  </div>
...
<?php
	if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
		...
		foreach($sheet as $row){ 
			...
			if(empty($no_it) && empty($komponen) && empty($sub_komponen) && empty($jumlah) && empty($pencapaian))
			...
			if($numrow > 1){
				...
				$no_td = ( ! empty($no_it))? "" : " style='background: #E07171;'"; // Jika kosong, beri warna merah
				$komponen_td = ( ! empty($komponen))? "" : " style='background: #E07171;'"; // Jika kosong, beri warna merah
				$sub_komponen_td = ( ! empty($sub_komponen))? "" : " style='background: #E07171;'"; // Jika kosong, beri warna merah
				$jumlah_td = ( ! empty($jumlah))? "" : " style='background: #E07171;'"; // Jika kosong, beri warna merah
				$pencapaian_td = ( ! empty($pencapaian))? "" : " style='background: #E07171;'"; // Jika kosong, beri warna merah
