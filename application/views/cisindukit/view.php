<!--MENU ATAS-->	
	...
	<section class="content-header">
		<h4>
          <b>STANDAR INDUK CIS DEP TI RSH BARU TIPE C</b>
        </h4>
    </section>
<style type="text/css">
table {
          ...
          <div class="row">
            <div class="col-md-12">
			 <div class="box box-primary">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url("index.php/cis_it/form"); ?>" class="btn btn-warning no-radius dropdown-toggle">
			  <i class="glyphicon glyphicon-download-alt"></i> IMPORT DATA </a>

			  <!--<a style="margin-bottom:3px" href="<?php echo base_url(); ?>LaporanCisIndukIT/Cetak_CisIndukIT" target='blank' class="btn btn-success">
			  <i class="fa fa-thumb-tack"></i> PRINT PDF </a> salah koding -->
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url(); ?>Cis_it/delete" 
			  class="btn btn-danger no-radius dropdown-toggle"><i class="glyphicon glyphicon-trash"></i> DELETE </a>
				
				<div class="col-md-12">
			
				<div class="col-md-1">
					<form action="<?php echo base_url(); ?>LaporanCisIndukIT/Cetak_CisIndukIT" target='blank' method="POST">
					<?php foreach($namadept as $dt) { ?>
					<input type="hidden" name="nama_cis" value="<?php echo $dt['nama_cis'] = "induk"; ?>"  class="form-control">
				...
				<div class="col-md-1">
					<form action="<?php echo base_url(); ?>LaporanCisIndukIT/Cetak_CisIndukIT_D" method="POST">
					<?php foreach($namadept as $dt) { ?>
					<input type="hidden" name="nama_cis" value="<?php echo $dt['nama_cis'] = "induk"; ?>"  class="form-control">
                 ...
                 <table id="tb-datatables">
                  <thead>
                    <tr style="background-color: #E6E6FA;">
						...
						<th style="vertical-align:middle;text-align:center;" width="80">KOMPONEN</th>
						<th style="vertical-align:middle;text-align:center;" width="150">SUB KOMPONEN</th>
						<th style="vertical-align:middle;text-align:center;" width="50">JUMLAH</th>
						<th style="vertical-align:middle;text-align:center;" width="100">PENCAPAIAN</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php $no=0; foreach($CIS_INDUK_IT as $dt) { $no++ ?>
                    <tr>
						<td style="text-align:center;" width="5"><?php echo $no; ?></td>
						<td style="text-align:center;" width="5"><?php echo $dt->no_it; ?></td>
						<td style="text-align:left;" width="80"><?php echo $dt->komponen; ?></td>
						<td style="text-align:left;" width="150"><?php echo $dt->sub_komponen; ?></td>
						<td style="text-align:center;" width="50"><?php echo $dt->jumlah; ?></td>
						<td style="text-align:left;" width="100"><?php echo $dt->pencapaian; ?></td>
