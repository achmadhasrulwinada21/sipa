          ...
          <div class="row">
            <div class="col-md-12">
			 <div class="box box-primary">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url("index.php/cis_it_man/form"); ?>" class="btn btn-warning no-radius dropdown-toggle">
			  <i class="glyphicon glyphicon-download-alt"></i> IMPORT DATA </a>

			   <!--<a style="margin-bottom:3px" href="<?php echo base_url(); ?>LaporanCisManIT/Cetak_CisManIT" target='blank' class="btn btn-success">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url(); ?>cis_it_man/delete" 
			  class="btn btn-danger no-radius dropdown-toggle"><i class="glyphicon glyphicon-trash"></i> DELETE </a>
				
				<div class="col-md-12">
			
				<div class="col-md-1">
					<form action="<?php echo base_url(); ?>LaporanCisManIT/Cetak_CisManIT" target='blank' method="POST">
					<?php foreach($namadept as $dt) { ?>
					<input type="hidden" name="nama_cis" value="<?php echo $dt['nama_cis'] = "man"; ?>"  class="form-control">
				...
				<div class="col-md-1">
					<form action="<?php echo base_url(); ?>LaporanCisManIT/Cetak_CisManIT_D" method="POST">
					<?php foreach($namadept as $dt) { ?>
					<input type="hidden" name="nama_cis" value="<?php echo $dt['nama_cis'] = "man"; ?>"  class="form-control">
                 ...
                 <table id="tb-datatables">
                  <thead>
                    <tr style="background-color: #E6E6FA;">
						...
						<th style="vertical-align:middle;text-align:center;" width="100">JABATAN</th>
						<th style="vertical-align:middle;text-align:center;" width="50">JUMLAH STANDAR</th>
						<th style="vertical-align:middle;text-align:center;" width="80">KUALIFIKASI</th>
						<th style="vertical-align:middle;text-align:center;" width="40">LEVEL</th>
						<th style="vertical-align:middle;text-align:center;" width="130">DIKLAT</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php $no=0; foreach($CIS_MAN_IT as $dt) { $no++ ?>
                    <tr>
						<td style="text-align:center;" width="5"><?php echo $no; ?></td>
						<td style="text-align:center;" width="5"><?php echo $dt->no_it_man; ?></td>
						<td style="text-align:left;" width="100"><?php echo $dt->jabatan; ?></td>
						<td style="text-align:center;" width="50"><?php echo $dt->jmlh_standar; ?></td>
						<td style="text-align:center;" width="80"><?php echo $dt->kualifikasi; ?></td>
						<td style="text-align:center;" width="40"><?php echo $dt->level; ?></td>
						<td style="text-align:left;" width="130"><?php echo $dt->diklat; ?></td>
