	<section class="content-header">
		<h4>
          <b>STANDAR MATERIAL CIS DEP TI RSH BARU TIPE C</b>
        </h4>
    </section>
...
<!-- Main content -->
          ...
          <div class="row">
            <div class="col-md-12">
			 <div class="box box-primary">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url("excel/cis_material_it.xlsx");?>" 
			  class="btn btn-info no-radius dropdown-toggle"><i class="glyphicon glyphicon-floppy-save"></i> DOWNLOAD FORMAT UPLOAD </a>
			  
			  <a style="margin-bottom:3px" href="<?php echo base_url("excel/import_data_material_cis_it.xlsx");?>" 
		...
		<form method="post" action="<?php echo base_url("index.php/cis_it_material/form"); ?>" enctype="multipart/form-data">
...
<?php
	if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
		...
		echo "<form method='post' action='".base_url("index.php/cis_it_material/import")."'>";
		...
		foreach($sheet as $row){ 
			...
			$no_it_mat = $row['A']; // Ambil data 
			$material = $row['B']; // Ambil data 
			...
			if(empty($no_it_mat) && empty($material) && empty($bagian) && empty($spek) && empty($jumlah) && empty($harga) && empty($total) && empty($keterangan) && empty($kode_role))
			...
			if($numrow > 1){
				...
				$no_it_td = ( ! empty($no_it_mat))? "" : " "; 
				$material_td = ( ! empty($material))? "" : " "; 
				...
				echo "<tr>";
				echo "<td style='text-align:center;' ".$no_it_td.">".$no_it_mat."</td>";
		...
		<?php
			...
			echo " <button type='submit' name='cancel'> <a href='".base_url("index.php/cis_it_material/form")."'>  Cancel </a></button>";
		}
	...
	<br><br>
		...
		<a style="margin-bottom:3px" href="<?php echo base_url("index.php/cis_it_material"); ?>" 
