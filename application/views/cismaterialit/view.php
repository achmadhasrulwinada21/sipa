          ...
          <div class="row">
            <div class="col-md-12">
			 <div class="box box-primary">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url("index.php/cis_it_material/form"); ?>" class="btn btn-warning no-radius dropdown-toggle">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url(); ?>cis_it_material/delete" 
			  class="btn btn-danger no-radius dropdown-toggle"><i class="glyphicon glyphicon-trash"></i> DELETE </a>
				
				<div class="col-md-12">
			
				<div class="col-md-1">
					<form action="<?php echo base_url(); ?>LaporanCisMaterialIT/Cetak_CisMaterialIT" target='blank' method="POST">
					<?php foreach($namadept as $dt) { ?>
					<input type="hidden" name="nama_cis" value="<?php echo $dt['nama_cis'] = "material"; ?>"  class="form-control">
				...
				<div class="col-md-1">
					<form action="<?php echo base_url(); ?>LaporanCisMaterialIT/Cetak_CisMaterialIT_D" method="POST">
					<?php foreach($namadept as $dt) { ?>
					<input type="hidden" name="nama_cis" value="<?php echo $dt['nama_cis'] = "material"; ?>"  class="form-control">
                 ...
                 <table id="tb-datatables">
                  <thead>
                    <tr style="background-color: #E6E6FA;">
						...
						<th style="vertical-align:middle;text-align:center;" width="120">MATERIAL</th>
                  ...
                  <tbody>
                    <?php $no=0; foreach($CIS_MATERIAL_IT as $dt) { $no++ ?>
                    <tr>
						<td style="text-align:center;" width="5"><?php echo $no; ?></td>
						<td style="text-align:center;" width="5"><?php echo $dt->no_it_mat; ?></td>
						<td style="text-align:left;" width="120"><?php echo $dt->material; ?></td>
