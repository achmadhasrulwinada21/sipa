          ...
          <div class="row">
            <div class="col-md-12">
			 <div class="box box-primary">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url("index.php/cis_it_money/form"); ?>" class="btn btn-warning no-radius dropdown-toggle">
			 ...
			 <!-- <button data-toggle="modal" data-target="#myModal" class="btn btn-success"> <span class="fa fa-thumb-tack"></span> LIHAT PDF </button>-->
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url(); ?>cis_it_money/delete" 
			  class="btn btn-danger no-radius dropdown-toggle"><i class="glyphicon glyphicon-trash"></i> DELETE </a>
			
			<div class="col-md-12">
			
				<div class="col-md-1">
					<form action="<?php echo base_url(); ?>LaporanCisMoneyIT/Cetak_CisMoneyIT" target='blank' method="POST">
                 ...
                 <table id="tb-datatables">
                  <thead>
                    <tr style="background-color: #E6E6FA;">
						...
						<th style="vertical-align:middle;text-align:center;" width="100">HARGA</th>
						<th style="vertical-align:middle;text-align:center;" width="100">TOTAL</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php $no=0; foreach($CIS_MONEY_IT as $dt) { $no++ ?>
                    <tr>
						<td style="text-align:center;" width="5"><?php echo $no; ?></td>
						<td style="text-align:center;" width="5"><?php echo $dt->no_it_mon; ?></td>
						...
						<td style="text-align:left;" width="100">Rp. <?php echo number_format ($dt->harga, 0, ".", "."); ?></td>
						<td style="text-align:left;" width="100">Rp. <?php echo number_format ($dt->total, 0, ".", "."); ?></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
