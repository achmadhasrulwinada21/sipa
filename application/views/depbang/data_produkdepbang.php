 <section class="content-header">
            ...
            <div class="box">       
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                  ...
                  <form role="form" action="<?php echo base_url(); ?>Depbangtr/savedatas_alum" method="POST"  enctype="multipart/form-data">
                  <div class="col-lg-12">
        ...
        <div style="text-align:left;margin-left:5%;" class="form-actions">
            ...
            <a href="<?php echo site_url('Depbangtr')?>" class="btn"><i class="icon-remove-sign"></i> BATAL </a>
        </div>
    </form>
</div>
<br>
                  ...
                  <tbody>
                   ...
                   if($kode !='10' and $kode !='15' ):?>
                       <td style="vertical-align: middle;text-align: center;">
                        ...
                        <a style="margin-bottom:3px;" class="btn btn-success btn-sm" href="<?php echo base_url(); ?>Depbangtr/adddetail_alumc/<?php echo $row['idpr2']; ?>"><i class="fa fa-plus">&nbsptambah detail</i></a> 
                       <a style="margin-bottom:3px;" class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>Depbangtr/editprodukodepbang/<?php echo $row['idpr2']; ?>"><i class="glyphicon glyphicon-edit"></i></a> 
                                         <a  style="margin-bottom:3px;" onclick="return confirm('Hapus data beserta detail??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>Depbangtr/hapusproddepbang/<?php echo $row['idpr2']; ?>/<?php echo $row['kode_th']; ?>/<?php echo $row['tanggal_tr']; ?>"><i class="glyphicon glyphicon-remove"></i></a>  
                     </td><?php endif;?>
                    </tr>
                              <?php
