          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                  <form role="form" form name="form1"  action="<?php echo base_url(); ?>Depbangtr/updateabksdalum" method="POST" enctype="multipart/form-data">
                     <div class="col-lg-12">                  
                     ...
                     <div class="form-group">
                      <label for="">NAMA PRODUK (DEPBANG)</label><b style="color:red;">&nbsp*harus diisi</b><br>
                       <select id="kode_produk" name="kode_produk" class="form control">
                          <option value="">pilih produk(depbang)</option>
                  ...
                  <a href="<?php echo base_url(); ?>Depbangtr/adddetail_alumc/<?php echo $kode_tr; ?>" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div>
                </div><!-- /.item -->
