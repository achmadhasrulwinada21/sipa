          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                  <form role="form" form name="form1"  action="<?php echo base_url(); ?>Depbangtr/updateoutstanding" method="POST" enctype="multipart/form-data">
                     <div class="col-lg-12">                  
                  ...
                  <input type="hidden" class="form-control" value="<?php echo $catatanheadrevisi;?>" name="catatanheadrevisi">   
                   ...
                   <div class="form-group">
                      <label for="">NAMA PERUSAHAAN</label><br>
                       <select id="" name="koper2" class="chosen form-control" required>
                          <option required></option>
                            <?php foreach($prinsper as $data) {
                          if(!in_array($data['koper'],$for_prinsper)){ ?>
                  ...
                  <div class="form-group">
                      <label for="">KETERANGAN</label>
                       <input type="text" class="form-control" value="<?php echo $ket; ?>" name="ket" id="" placeholder="KETERANGAN"/>                 
                    </div>
					<div class="form-group">
                      <label for="">CATATAN</label>
                       <input type="text" class="form-control" value="<?php echo $note; ?>" name="note" id="" placeholder="CATATAN"/>                 
                    </div>
                    <div class="form-group">
                      <label for="">CONTACT PERSON</label>
                       <input type="text" class="form-control" value="<?php echo $contact; ?>" name="contact" id="" placeholder="CONTACT PERSON"/>
                    </div>
                  ...
                  <a href="<?php echo base_url(); ?>Depbangtr/lihattrdephistori" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div>
                </div><!-- /.item -->
