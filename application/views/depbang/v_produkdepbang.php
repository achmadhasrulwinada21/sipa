                  ...
                  <tbody>
                   ...
                   if($kode =='10' or $kode =='70' or $kode =='82'):?>
                       <td style="vertical-align: middle;text-align: center;">
                        ...
                        <a style="margin-bottom:3px;" class="btn btn-success btn-sm" href="<?php echo base_url(); ?>Depbangtr/adddetail_alumc/<?php echo $row['idpr2']; ?>/<?php echo $row['koper']; ?>"><i class="fa fa-plus">&nbspdetail</i></a>
  ...
  <div class="panel panel-primary">
       <div class="panel-heading">
        ...
        <div class="modal-body">
                  <form role="form" action="<?php echo base_url(); ?>Depbangtr/updaterejecthead" method="POST" enctype="multipart/form-data">
                  <div class="col-md-6">
...
<div id="modal_editdaranisa<?php echo $idpr2;?>" class="modal fade">
  ...
  <div class="panel panel-primary">
       <div class="panel-heading">
        ...
        <div class="modal-body">
                  <form role="form" action="<?php echo base_url(); ?>Depbangtr/updaterejecthead2" method="POST" enctype="multipart/form-data">
                  <div class="col-md-6">
                     <input type="hidden" class="form-control" value="<?php echo $idpr2;?>" id="" name="idpr2">
                      <input type="hidden" class="form-control" value="<?php echo $tanggal_tr;?>" id="" name="tanggal">
                      <input type="hidden" class="form-control" value="<?php echo $id_tipe_produk;?>" id="" name="id_tipe_produk">
