<section class="content-header">
        <h4 style="text-align: center;">
          <b><span>RR-LISTING DATA PRODUK DEPBANG</span></b>
        </h4>
        </section>
          ...
          <div class="row">
            ...
            <div class="box">    
               ...
               <br>
                     ...
                     <div class="col-lg-12">
                       <a style="margin-bottom:3px" href="<?php echo base_url(); ?>Lapdepbang/expor_detildepbang" class="btn btn-primary no-radius dropdown-toggle"><i class="fa fa-print"></i> PRINT </a>     
                ...
                <div class="box-body">      
        <br>
        <table id="table77" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
