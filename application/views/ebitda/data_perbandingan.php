<section class="content-header">
        ...
        <section class="content">
           ...
           <div class="box"><br>
             ...
             <span style="margin-left: 20px;"><a href="<?php echo base_url(); ?>Ebitda" class="btn btn-success"><i class="fa fa-home">&nbspKembali</i></a></span>
              <a id="btn-Preview-Image" type="button" class="btn btn-success" /><i class="fa fa-desktop">&nbspPreview</i></a>
    <a id="btn-Convert-Html2Image" class="btn btn-success" href="#"><i class="fa fa-download">&nbspDownload</i></a>
    
    <br/>
    <h3 style="margin-left: 20px;">Preview :</h3>
    <div id="previewImage">
    </div>

                         <div class="box-header" id="html-content-holder">
 ...
 height: 2px; margin: 0 auto"></div>
            <canvas id="demobar6" style="margin-left: 10px" width="250" height="75"></canvas>
    </div>
                ...
                <div class="box-body">
                 ...
                 <table id="" class="table table-bordered table-striped">
                  <thead>
                   <div class="container" style="min-width: 2px;
 height: 2px; margin: 0 auto"></div>
            <canvas id="demobar5" style="margin-left: 10px" width="250" height="75"></canvas>
    </div>
                ...
                <div class="box-body">
                 ...
                 <table id="" class="table table-bordered table-striped">
                  <thead>
                   <div class="container" style="min-width: 2px;
 height: 2px; margin: 0 auto"></div>
            <canvas id="demobar4" style="margin-left: 10px" width="250" height="75"></canvas>
    </div>
