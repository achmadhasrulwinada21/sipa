 ...
 header("Content-Disposition: attachment; filename=laporan_RR-Listing_detil_alum.xls");
  ...
  function ubahbulan($namabln)
{
 ...
 <h4 style="text-align: center;">
          <b><span>Laporan RR-Listing Detail Alat Umum<br>
...
<?php
          ...
          $cetak_alum = $this->produkom2->Getprodukalum("where koper='$koper' and statusdetil !='1' and statusdetil !='01' and statusdetil!='2' and statusdetil!='3' and statusdetil!='4'")->result_array();
?>
           <table>     
           <?php        
            $i=0;   
