 ...
 header("Content-Disposition: attachment; filename=laporan_detail_katalog_alum.xls");
 ...
 <h4 style="text-align: center;">
          <b><span>Laporan Detail E - Katalog Alat Umum<br>
          </span></b>
        </h4>
...
<?php
          ...
          $cetak_alum = $this->produkom2->GetprodukalumV("where koper='$koper' and tanggal_tr='$tanggal_tr'   and statusdetil !='1' and statusdetil !='01' and statusdetil!='2' and statusdetil!='3' and statusdetil!='4' ")->result_array();
?>
           <table>     
           <?php        
            $i=0;   
