 ...
 $ynwa = ($this->session->userdata('koderole'));
  ...
  <ul class="nav nav-tabs">
    <li class=""><a href="<?php echo base_url(); ?>form_kegiatan">Form Rencana</a></li>
     <li class="active"><a href="<?php echo base_url(); ?>form_kegiatan/Disetujui_rencana">Form Realisasi</a></li>
...
<link rel="stylesheet" href="<?php echo base_url('assets/css/select2.min.css') ?>"/>	    
 ...
 $ynwa = ($this->session->userdata('koderole'));
          if($ynwa!='10'):?> 
					           <th  style="vertical-align: middle;text-align: center;">TAMBAH REALISASI</th>
<?php endif;?>
 ...
 $ynwa = ($this->session->userdata('koderole'));
          if($ynwa!='10'):?> 
                        ...
                        <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>form_kegiatan/adddetail2/<?php echo $row['idfkeg']; ?>"><i class="fa fa-plus"></i></a></td>
                         <?php endif;?>
                        <td style="vertical-align: middle;text-align: center;">
