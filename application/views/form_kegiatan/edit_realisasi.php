        ...
        <div class="row">
          ...
          <section class="col-lg-12">
            ...
            <label type="hidden" for="">Approve</label>
              ...
              <option value="Approve_rencana">--Pilih Status--</option>
              <option <?php if( $status=='Approve_realisasi'){echo "selected"; } ?> value='Approve_realisasi'>Disetujui Anggaran realisasi</option>
              <option <?php if( $status=='Not_Approved_realisasi'){echo "selected"; } ?> value='Not_Approved_realisasi'>Ditolak Anggaran realisasi</option>
              <option <?php if( $status=='Revisi_realisasi'){echo "selected"; } ?> value='Revisi_realisasi'>Revisi Anggaran realisasi</option>
              </select><option>
                  </div>       
                    <div class="form-group">
