          ...
          <div class="row">
           ...
           <div class="box">
              <div class="box-body chat" id="chat-box">
                <!-- chat item --><br><br>
                <form role="form" action="<?php echo base_url(); ?>Laporanalkes/expor_detilalkes" method="POST"  enctype="multipart/form-data" target="blank">
            ...
            <button  type="submit" class="btn btn-info"><i class="fa fa-print"></i> PRINT </button>
               ...
               <a class="btn btn-success btn-md" href="<?php echo base_url(); ?>Alkestransaksi/cetakalkes"><i class="glyphicon glyphicon-home"></i>&nbsp KEMBALI</a><br>
                <div class="item">
              </div><br></section>
              <section>  
            <div class="col-md-12">
                  ...
                  <tbody>
                   <?php $no=0;
                    ...
                    <tr>
                      ...
                      <td style="vertical-align: middle;text-align: center;"><?php echo $row['nm_perusahaan']; ?></td>
                       ...
                       <td style="vertical-align: middle;text-align: center;"><a  href="<?php echo base_url(); ?>Alkestransaksi/lihatdetailalkes/<?php echo $row['idpr2']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-desktop">&nbspLIHAT DETAIL PRODUK</i></a></td>
                    </tr>
                              <?php
