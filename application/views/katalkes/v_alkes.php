        ...
        <tr>
            ...
            <td style="text-align:center;"><?php echo ($pkj['tanggal']); ?></td>
             ...
             <td style="text-align:center;"> 
               <a style="margin-bottom:3px;" class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>Alkestransaksi/lihattralkes/<?php echo $pkj['tanggal']; ?>/<?php echo $pkj['kode_trans']; ?>"><i class="fa fa-desktop">&nbsplihat transaksi</i></a> 
               
             <a style="margin-bottom:3px;" target="blank" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>Laporanalkes/cetak_alkes/<?php echo $pkj['kode_trans']; ?>"><i class="fa fa-print">&nbspPRINT</i></a>
             </td>
            <?php } ?>
                  </tbody>          
        </table>
