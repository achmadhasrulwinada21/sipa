          ...
          <div class="row">
            ...
            <div class="box">       
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                 <a style="margin-top:5px;" class="btn btn-success btn-md" href="<?php echo base_url(); ?>produko2/alkes"><i class="glyphicon glyphicon-home"></i>&nbsp KEMBALI</a><br>
                <div class="item">
                  ...
                  <tbody>
                   ...
                   if($kode =='10' or $kode =='52' or $kode =='82'):?>
                       <td style="vertical-align: middle;text-align: center;">
                        ...
                        <a style="margin-bottom:3px;" class="btn btn-success btn-sm" href="<?php echo base_url(); ?>produko2/adddetail_alkesc/<?php echo $row['idpr2']; ?>/<?php echo $row['koper']; ?>"><i class="fa fa-plus">&nbspdetail</i></a>
...
<div id="modal_edit<?php echo $idpr2;?>" class="modal fade">
  ...
  <div class="panel panel-danger">
    ...
    $tampil= $this->produkom2->Getprodukms2alkes("where kode_tr='$idpr2' and (statusdetil='0'
      or statusdetil is null) ")->result_array();
    $prod = $this->db->get_where('v_produkoalkes',['idpr2'=>$idpr2])->row();

    }
        ?>
                        <?php include 'tampil_produkalkes2.php';?>
