<section class="content-header">
        <h4 style="text-align: center;">
          <b><span>RR LISTING PRODUK ALKES</span></b>
        </h4>
        </section>
...
<button data-toggle="modal" data-target="#myModal" class="btn btn-success" style="margin-left:2%"><span class="glyphicon glyphicon-print"></span>&nbspPRINT</button><br> 
                <div class="table-responsive">
                <div class="box-body">      
        <br>
        <table id="table21" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
...
<form action="<?php echo base_url(); ?>Laporanalkes/expor_detilalkes2" method="POST">
