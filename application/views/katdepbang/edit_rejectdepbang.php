          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>Depbangtransaksi/updatereject" method="POST" enctype="multipart/form-data">
                  ...
                  <?php
                   ...
                   <input type="hidden" class="form-control" value="<?php echo $idtrcom;?>" name="idtrcom">
                     ...
                     <div class="form-group" hidden >
                      <input type="text" class="form-control" value="<?php echo $koders; ?>" id="" name="koders"  />                      
                    </div> 
                 ...
                 <input type="hidden" class="form-control" value="4" id="" name="status">
                  ...
                  <a href="<?php echo base_url(); ?>Depbangtransaksi" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div>
                </div><!-- /.item -->
