<?php
 ...
 header("Content-Disposition: attachment; filename=laporan_detail_listing_obat.xls");
...
<?php
          ...
          $cetak_farmasi = $this->obatreg->Get_obat_outs_lop("where koper='$koper'")->result_array();
?>
           <table>     
           <?php        
 ...
 <td style="text-align:justify;"><?php echo $row['golonganid']; ?></td>
    <td style="text-align:justify;"><?php echo $row['komposisi']; ?></td>  
   <td style="text-align:right;"><?php echo $row['harga_akhir_baru']; ?></td> 
