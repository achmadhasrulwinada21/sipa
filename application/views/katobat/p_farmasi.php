 ...
 <div class="box-body">
           ...
           <div class="box-body table-responsive">
             ...
             <td style="text-align:center;"> 
              <a style="margin-bottom:3px;" class="btn btn-info btn-sm" href="<?php echo base_url(); ?>Obattr/lihattrfarmasi/<?php echo $pkj['idtrcom']; ?>/<?php echo $pkj['tanggal']; ?>"><i class="fa fa-desktop">&nbsplihat</i></a> 
 
<?php
                          $darabus=($this->session->userdata('koderole'));
                   if($darabus =='69' || $darabus =='56' ):?>
                <a style="margin-bottom:3px;" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal_editdara<?php echo $pkj['idtrcom'];?>"><i class="glyphicon glyphicon-ok"></i>&nbsppublish</a>
                 <?php endif;?> 
  ...
  <div class="panel panel-danger">
       <div class="panel-heading">
        ...
        <div class="modal-body">
                  <form role="form" action="<?php echo base_url(); ?>Obattr/updateaprovepublis" method="POST" enctype="multipart/form-data">
                  <div class="col-md-6">
