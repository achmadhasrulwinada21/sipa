          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>Farmasitransaksi/updatefarmasihead" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <a href="<?php echo base_url(); ?>Farmasitransaksi/addtrfarmasi/<?php echo $kode_th; ?>/<?php echo $tanggal_tr; ?>" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div>
                </div><!-- /.item -->
