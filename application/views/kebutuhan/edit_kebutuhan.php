          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              <div class="box-header">
                ...
                <h3 class="box-title">EDIT DATA KEBUTUHAN</h3>
              </div>
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>Ckebutuhan/updatekebutuhan" method="POST" enctype="multipart/form-data">
                  <div class="col-lg-6">
                    <div class="form-group">

                      <label for=""></label>
                        <input type="char" class="form-control" value="<?php echo $id_kebutuhan;?>" id="" name="id_kebutuhan" placeholder="" readonly="" >
                      </div>
                    ...
                    <div class="form-group">
                      <label for="">Nama Kebutuhan</label>
                        <input type="text" class="form-control" value="<?php echo $nama_kebutuhan; ?>" id="" name="nama_kebutuhan" placeholder="Nama Uraian" required>                        
                    </div>
                      <div class="form-group">
