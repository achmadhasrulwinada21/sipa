      ...
      <section class="content-header">
        <h1>
          <b>DATA KINERJA <?php echo $this->session->userdata('namars'); ?> BAGIAN FRONT OFFICE   </b>
        </h1>
          <!-- <ol class="breadcrumb">
        ...
        <!--<a style="margin-bottom:3px" href="<?php echo base_url(); ?>laporan_kinerjahermina/cetak_kinerja" class="btn btn-primary no-radius dropdown-toggle"><i class="fa fa-plus"></i> PRINT </a>-->
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <tbody>
                    <?php $no=0; foreach($data_krs as $row) { $no++ ?>
                    <tr>
                      <td><?php echo $no; ?></td>
                      <td><?php echo $row['periode']; ?></td>
                       <td><?php echo $row['nama_rs']; ?></td>
                       <td><?php echo $row['uraian_rsk']; ?></td>
                      <td><?php echo $row['real_rsk']; ?></td>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="">URAIAN</label>
                        <input type="text" class="form-control" value="<?php echo $uraian_rsk; ?>" id="" name="uraian_rsk" required>
                    </div>

                    <div class="form-group">
                      <label for="">DATA REAL</label>
                        <input type="text" class="form-control" value="<?php echo $real_rsk; ?>" id="" name="real_rsk" > 
                      </div>         
                    </div>
