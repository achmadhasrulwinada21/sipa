                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      ...
                      <label for="">URAIAN</label>
                        <input type="text" class="form-control" value="<?php echo $uraian_rsk; ?>"  name="uraian_rsk" placeholder="Uraian" required>
                    </div>

                    <div class="form-group">
                      <label for="">DATA REAL</label>
                        <input type="text" class="form-control" value="<?php echo $real_rsk; ?>" id="" name="real_rsk" placeholder="Data Real" required>                        
                    </div>
                      <!-- <div class="form-group">
