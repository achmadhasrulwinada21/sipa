...
<link rel="shortcut icon" href="<?= base_url('') ?>assets/img/favicon-hermina.png"> 
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="login">
...
<div class="logo">
	...
	<img src="<?= base_url('')?>assets/img/Hermina.png" alt="" width="130px">
	<!--<img src="<?= base_url('')?>assets/admin/layout2/img/logo-big.png" alt=""/>-->
	<h3 class="form-title"><label class="label label-success">SISTEM INFORMASI PROSES ADMINISTRASI</label></h3>
	<h3 class="form-title"><label class="label label-warning">Version 1.0.1</label></h3>
...
<div class="content">
	...
	<!--<form action="<?php echo site_url('login/proses')?>" autocomplete="off" method="POST">-->
		<!--<h3 class="form-title">SISTEM INFORMASI PROSES ADMINISTRASI </h3>-->
		 ...
		 <?php
                    ...
                    if (validation_errors() || $this->session->flashdata('result_login')) {
                        ...
                        <div class="alert alert-danger">
                            ...
                            <span><?php echo $this->session->flashdata('result_login'); ?></span>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	   <p style="color:yellow;">2019 &copy; PT. Medikaloka Hermina, Tbk.</p>
</div>
<!-- END COPYRIGHT -->
...
Layout.init(); // init current layout
  ...
  Demo.init();
       ...
       $.backstretch([
        "<?= base_url('')?>assets/admin/pages/media/bg/1.png",
