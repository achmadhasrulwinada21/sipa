<ul class="nav nav-tabs">
    <li class=""><a href="<?php echo base_url(); ?>cmasterprinsp">Prinsipal</a></li>
     <li class=""><a href="<?php echo base_url(); ?>cmasterprinsp/alum">ALUM</a></li>
     <li class="active"><a href="<?php echo base_url(); ?>cmasterprinsp/alkes">ALKES</a></li>
 </ul>
	...
	<section class="content">
        ...
        <div class="row">
          ...
          <section class="col-lg-12">
            ...
            <div class="box"> 		  
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>cmasterprinsp/savedata_alkes" method="POST"  enctype="multipart/form-data">
                  <div class="col-lg-12">
				  <div class="col-lg-6">
				  <div class="box-body chat" id="chat-box">
				  <!--
         ...
         <!--  <input type="radio" name="tipe_produk" id="obat"  onclick="javascript:yesnoCheck();">PERUSAHAAN OBAT<br>
            ...
            <input type="radio" name="tipe_produk" id="alkes"  onclick="javascript:yesnoCheck();">PERUSAHAAN ALKES<br><br> -->
                      ...
                      <div class="form-group">
                      <label for="">Nama Alkes</label><br>
                        <select id="alkesid" name="alkesid" class="chosen" required>
                          <option value="-"></option>
                          <?php foreach($kode_alkes as $row) { ?>
                              <option value="<?php echo $row['alkesid'] ?>"><?php echo $row['pt_alkes'] ?></option>
                          <?php } ?>
                        </select><br>
                         <input type="hidden" class="form-control"  value="-" id="" name="alkesnama" required>    
                         <input type="hidden" class="form-control"  value="-" id="" name="pt_alkes" required><br>
                       <label for="">KODE DISTRIBUTOR</label>
                        <input type="text" class="form-control"  value="-" id="" name="distalkesid" required>
                        <br> <label for="">NAMA DISTRIBUTOR</label>
                         <input type="text" class="form-control"  value="-" id="" name="distalkesnama" placeholder="Isikan Nama PT (Prinsipal)" required>             
                    </div>
        ...
        <div style="text-align:center;" class="form-actions">
            ...
            <a href="<?php echo site_url('cmasterprinsp/alkes')?>" class="btn"><i class="icon-remove-sign"></i> BATAL </a>
        </div>
    </form>
</div>
</div>
...
<div class="box-body">
           <span><b>B. PERUSAHAAN ALKES</b></span><br>
              ...
              <table id="datatables9" class="table table-bordered table-striped">
                  ...
                  <thead bgcolor="#DCDCDC" >
                    <tr>
                      ...
                      <th style="text-align:center;">Nama Alkes</th>
                  ...
                  <tbody>
                    ...
                    <?php $no=0; foreach($data_alkes as $pkj) 
          {

          $no++ ?>
        <tr>         
            <td style="text-align:center;"><?php echo $no; ?></td> 
            <td style="text-align:center;"><?php echo ($pkj['alkesnama']); ?></td>
            <td style="text-align:left;"><?php echo ($pkj['pt_alkes']); ?></td>
             <td style="text-align:left;"><?php echo ($pkj['distalkesid']); ?></td>
           <!-- <td style="text-align:center;">
                      
                      <a onclick="return confirm('Anda Yakin Hapus Data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>cmasterprinsp/hapus_alkes/<?php echo $pkj['idalkess']; ?>"><i class="glyphicon glyphicon-trash"></i></a>
