<ul class="nav nav-tabs">
    <li class="active"><a href="<?php echo base_url(); ?>cmasterprinsp">Prinsipal</a></li>
	...
	<section class="content">
          ...
          <section class="col-lg-12">
            ...
            <div class="box"> 		  
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>cmasterprinsp/savedata" method="POST"  enctype="multipart/form-data">
                  <div class="col-lg-12">
            ...
            <input type="radio" name="tipe_produk" id="alkes"  onclick="javascript:yesnoCheck();">PERUSAHAAN ALKES<br><br> -->
					...
					<div class="form-group">
                      <label for="">Nama Prinsipal</label><br>
                        <select id="pabrikid" name="pabrik_id" class="chosen" required>
                          <option required></option>
                          <?php foreach($kode_pabrik as $row) { ?>
                              <option value="<?php echo $row['pabrikid'] ?>" required><?php echo $row['nama_pt'] ?></option>
                          <?php } ?>
                        </select> <br>
                         <input type="hidden" class="form-control"   id="" name="pabriknama" required>                     
                      <input type="hidden" class="form-control"   id="" name="nama_pt" required><br>
                       <label for="">KODE DISTRIBUTOR</label><br>
                        <select id="s_kode" name="s_kode" class="s_kode" required>
                          <option required></option>
                          <?php foreach($s_kode as $row) { ?>
                              <option value="<?php echo $row['s_kode'] ?>" required><?php echo $row['s_nama'] ?></option>
                          <?php } ?>
                        </select> 
                         <input type="hidden" class="form-control"  value="-" id="" name="s_nama" placeholder="Isikan Nama PT (Prinsipal)" required>             
                    </div>
        ...
        <div style="text-align:center;" class="form-actions">
            ...
            <a href="<?php echo site_url('cmasterprinsp')?>" class="btn"><i class="icon-remove-sign"></i> BATAL </a>
        </div>
    </form>
</div>
 ...
 <div class="box-body">
              ...
              <table id="datatables4" class="table table-bordered table-striped">
				...
				<tr>         
					...
					<!--  <td style="text-align:center;"><?php echo ($pkj['pabriknama']); ?></td> -->
					  <td style="text-align:left;"><?php echo ($pkj['nama_pt']); ?></td>
             <td style="text-align:left;"><?php echo ($pkj['s_kode']); ?></td>
					  <td style="text-align:center;">
                      
                      <a onclick="return confirm('Anda Yakin Hapus Data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>cmasterprinsp/hapus_item/<?php echo $pkj['idprinsipal']; ?>"><i class="glyphicon glyphicon-trash"></i></a>
