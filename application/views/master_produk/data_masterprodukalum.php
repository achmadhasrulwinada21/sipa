    ...
    <?php
     $kodedara=($this->session->userdata('koderole'));
       if($kodedara =='1' or $kodedara =='66' or $kodedara =='72' or $kodedara =='74' ):?>
          <li class="active"><a href="<?php echo base_url(); ?>C_mstproduk/alum">Data Produk alum</a></li>
    <?php endif;?>
...
<link href="<?php echo base_url('assets/datatables/css/dataTables.bootstrap.min.css')?>" rel="stylesheet">   
 ...
 <section class="content-header">
       ...
       <!--  <a style="margin-bottom:3px" href="<?php echo base_url("index.php/C_mstproduk/formalum"); ?>" class="btn btn-warning no-radius dropdown-toggle">
        <i class="glyphicon glyphicon-download-alt"></i> IMPORT DATA FROM EXCEL </a> -->

         <a style="margin-bottom:3px" href="<?php echo base_url("Excel_import/alum"); ?>" class="btn btn-warning no-radius dropdown-toggle">
        <i class="glyphicon glyphicon-download-alt"></i> IMPORT DATA FROM EXCEL </a>

        <a style="margin-bottom:3px" href="<?php echo base_url('C_mstproduk/v_export_excelalum') ?>" class="btn btn-danger no-radius dropdown-toggle">
          ...
          <div class="row">
            ...
            <div class="box">       
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>C_mstproduk/savedata2" method="POST"  enctype="multipart/form-data">
                  
          
				  <!-- <div class="box-body chat" id="chat-box"> -->

				  <div class="col-lg-6">
                    <input type="hidden" class="form-control" id="" name="tipe_produk" value="TP002" required>
                    <div class="form-group">
                      <label for="">KODE PRODUK</label>&nbsp<label style="color: red;">*</label>
                        <input type="text" class="form-control" id="" name="kode_produk" value="<?= $kodeunikalum; ?>" readonly>
                    </div>
  ...
  <div class="form-group">
       ...
       <br>
        ...
        <div style="text-align:center;" class="form-actions">
            ...
            <a href="<?php echo site_url('C_mstproduk/alum')?>" class="btn"><i class="icon-remove-sign"></i> BATAL </a>
        </div>
        </div>
    </form>
