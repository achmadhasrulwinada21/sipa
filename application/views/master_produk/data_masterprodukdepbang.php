   ...
   $kodedara=($this->session->userdata('koderole'));
    ...
    <?php endif;?>
     ...
     <?php
      $kodedara=($this->session->userdata('koderole'));
        if($kodedara =='1'):?>
          <li class="active"><a href="<?php echo base_url(); ?>C_mstproduk/depbang">Data Produk DepBang</a></li>
     <?php endif;?>
  </ul>   
...
<link href="<?php echo base_url('assets/datatables/css/dataTables.bootstrap.min.css')?>" rel="stylesheet">   
 ...
 <section class="content-header">
        <h4 style="text-align: center;">
          <b><span> DATA PRODUK DEPBANG</span></b>
        </h4>
        </section>
       ...
       <!--  <a style="margin-bottom:3px" href="<?php echo base_url("index.php/C_mstproduk/formdepbang"); ?>" class="btn btn-warning no-radius dropdown-toggle">
        <i class="glyphicon glyphicon-download-alt"></i> IMPORT DATA FROM EXCEL </a> -->

         <a style="margin-bottom:3px" href="<?php echo base_url("Excel_import/depbang"); ?>" class="btn btn-warning no-radius dropdown-toggle">
        <i class="glyphicon glyphicon-download-alt"></i> IMPORT DATA FROM EXCEL </a>

        <a style="margin-bottom:3px" href="<?php echo base_url('C_mstproduk/v_export_exceldepbang') ?>" class="btn btn-danger no-radius dropdown-toggle">
          ...
          <div class="row">
            ...
            <div class="box">       
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>C_mstproduk/savedata3" method="POST"  enctype="multipart/form-data">
                  
          
				  <!-- <div class="box-body chat" id="chat-box"> -->

				  <div class="col-lg-6">
                    <input type="hidden" class="form-control" id="" name="tipe_produk" value="TP004" required>
                    <div class="form-group">
                      <label for="">KODE PRODUK</label>&nbsp<label style="color: red;">*</label>
                        <input type="text" class="form-control" id="" name="kode_produk" value="<?= $kodeunikdepbang; ?>" readonly>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea rows="4" cols="54" class="form-control" name="deskripsi"></textarea>
                    </div>
                     </div>
                   ...
                   <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <label for="">VOLUME</label>
                        <input type="text" class="form-control" id="" name="volume" value='0'>
                    </div>
                 

                    <div class="form-group">
                      <label for="">SATUAN</label>
                        <select data-placeholder="Pilih Satuan" name="satuanid" class="form-control chosen1">
                          <option></option>
...
<div class="form-group">
                      <label for="">JENIS BARANG</label>&nbsp<label style="color: red;">*</label><br>
       ...
       <br>
        ...
        <div style="text-align:center;" class="form-actions">
            ...
            <a href="<?php echo site_url('C_mstproduk/depbang')?>" class="btn"><i class="icon-remove-sign"></i> BATAL </a>
        </div>
        </div>
    </form>
        ...
        <table id="table4" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr bgcolor="#4682B4" style="font-family: arial; color: white;">
                    ...
                    <th style="vertical-align: middle; text-align: center;">Spesifikasi Teknis / Tipe</th>
