          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              <div class="box-header">
                ...
                <h3 class="box-title">EDIT DEPBANG</h3>
              </div>
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>C_mstproduk/updatedepbang" method="POST" enctype="multipart/form-data">
...
<div class="form-group">
                      <label for="">JENIS BARANG</label>&nbsp<label style="color: red;">*</label>
                         <select id="" name="kd_jns_brg" class="form-control chosen" required>
                          <option required></option>
                            <?php foreach($prindepbang as $data) {
                          if(!in_array($data['kd_jns_brg'],$for_prindepbang)){ ?>
                ...
                <div class="form-group">
                  ...
                  <a href="<?php echo base_url(); ?>C_mstproduk/depbang" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div>
               </form>   
             </div>
           </div>
