...
<html>
<head>
	<title>IMPORT DATA DEPBANG</title>
...
<body>
	<div class="container">
		<div class="box">
		<br />
		<h3 align="center">IMPORT DATA DEPBANG</h3>
		<form method="post" id="import_formdepbang" enctype="multipart/form-data">
			<a style="margin-bottom:3px; margin-left: 5px" href="<?php echo base_url("download/detail_produkdepbang2.xlsx");?>" 
			  class="btn btn-info no-radius dropdown-toggle"><i class="glyphicon glyphicon-floppy-save"></i> DOWNLOAD FORMAT UPLOAD </a>
			 

			 <a style="margin-bottom:3px; margin-left: 30px" href="<?php echo base_url("download/detail_kodedepbang1.xlsx");?>" 
			...
			<input type="submit" name="import" value="Import" class="btn btn-warning no-radius dropdown-toggle" />
			 <a href="<?php echo base_url("C_mstproduk/depbang"); ?>"></i> Kembali </a></p> </div>
		</form>
		<br />
		<div class="table-responsive" id="depbang_data">
			</div>
		</div>
	</div>
</body>
