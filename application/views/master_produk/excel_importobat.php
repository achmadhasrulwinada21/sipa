...
<body>
		...
		<div class="box">
		<br />
		<h3 align="center">IMPORT DATA OBAT</h3>
		<form method="post" id="import_formobat" enctype="multipart/form-data">
			<a style="margin-bottom:3px; margin-left: 5px" href="<?php echo base_url("download/detail_produk.xlsx");?>" 
			  class="btn btn-info no-radius dropdown-toggle"><i class="glyphicon glyphicon-floppy-save"></i> DOWNLOAD FORMAT UPLOAD </a>
			  

			  <a style="margin-bottom:3px; margin-left: 30px" href="<?php echo base_url("download/detail_kodeobat.xlsx");?>" 
			...
			<input type="submit" name="import" value="Import" class="btn btn-warning no-radius dropdown-toggle" />
			 <a href="<?php echo base_url("C_mstproduk"); ?>"></i> Kembali </a></p> </div>
		</form>
		<br />
		<div class="table-responsive" id="obat_data">
			</div>
		</div>
