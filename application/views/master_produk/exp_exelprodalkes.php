	<section class="content-header">
		<h4>
          <b>IMPORT EXCEL DETAIL PRODUK ALKES</b>
        </h4>
    </section>
...
<!-- Main content -->
          ...
          <div class="row">
            <div class="col-md-12">
			 <div class="box box-primary">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url("excel/detail_produkalkes.xlsx");?>" 
		...
		<form method="post" action="<?php echo base_url("index.php/C_mstproduk/formalkes"); ?>" enctype="multipart/form-data">
...
<?php
	if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
		...
		echo "<form method='post' action='".base_url("index.php/C_mstproduk/importalkes")."'>";
		...
		foreach($sheet as $row){ 
			...
			if(empty($kode_produk) && empty($nama_produk) && empty($merk) && empty($tipe_produk) && empty($type) && empty($koper))
		...
		<?php
			...
			echo " <input type='submit' name='cancel'> <a href='".base_url("index.php/C_mstproduk/formalkes")."'>  Cancel </a>";
		}
	...
	<br><br>
	  ...
	  <br><br>
		<a style="margin-bottom:3px" href="<?php echo base_url("index.php/C_mstproduk/alkes"); ?>" 
