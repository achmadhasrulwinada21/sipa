...
<html>
<head>
	<title>IMPORT DATA SATUAN</title>
...
<body>
	<div class="container">
		<div class="box">
		<br />
		<h3 align="center">IMPORT DATA SATUAN</h3>
		<form method="post" id="import_form" enctype="multipart/form-data">
			<a style="margin-bottom:3px; margin-left: 5px" href="<?php echo base_url("download/detail_satuan.xlsx");?>" 
			...
			<input type="submit" name="import" value="Import" class="btn btn-warning no-radius dropdown-toggle" />
			 <a href="<?php echo base_url("C_mstsatuan"); ?>"></i> Kembali </a></p> </div>
		</form>
		<br />
		<div class="table-responsive" id="satuan_data">
			</div>
		</div>
	</div>
</body>
