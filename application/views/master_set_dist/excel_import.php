...
<html>
<head>
	<title>IMPORT DATA SETUP DISTRIBUTOR</title>
...
<body>
	<div class="container">
		<div class="box">
		<br />
		<h3 align="center">IMPORT DATA SETUP DISTRIBUTOR</h3>
		<form method="post" id="import_formsetdis" enctype="multipart/form-data">
			<a style="margin-bottom:3px; margin-left: 5px" href="<?php echo base_url("download/detail_setdis.xlsx");?>" 
			...
			<input type="submit" name="import" value="Import" class="btn btn-warning no-radius dropdown-toggle" />
			 <a href="<?php echo base_url("C_mstsetdis"); ?>"></i> Kembali </a></p> </div>
		</form>
		<br />
		<div class="table-responsive" id="setdis_data">
			</div>
		</div>
	</div>
</body>
