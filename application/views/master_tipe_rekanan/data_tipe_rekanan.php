	...
	<section class="content">
          ...
          <section class="col-lg-12">
            ...
            <div class="box"> 		  
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>cmastertiprek/savedata" method="POST"  enctype="multipart/form-data">
                  <div class="col-lg-12">
				  
				  <div class="box-body chat" id="chat-box">
                    <div class="form-group">
                      <label for="">Id Tipe Rekanan</label>
                        <input readonly type="text" class="form-control" value="<?php echo $kode_tipe_rekanan; ?>" id="" name="no_tipe_rekanan" placeholder="Isikan No Pengajuan" required>
                    </div>
                    <div class="form-group">
                      <label for="">Nama Tipe Rekanan</label>
                        <input type="text" class="form-control"  value="" id="" name="nm_tipe_rekanan" placeholder="Isikan Nama Tipe Rekanan" required>                        
                    </div>
        ...
        <div style="text-align:center;" class="form-actions">
            ...
            <a href="<?php echo site_url('cpengajuancab')?>" class="btn"><i class="icon-remove-sign"></i> BATAL </a>
        </div>
    </form>
</div>
              ...
              <table id="tb-datatables" class="table table-bordered table-striped">
                  ...
                  <thead bgcolor="#DCDCDC" >
                    <tr>
					  ...
					  <th style="text-align:center;">Id Tipe Rekanan</th>
                      <th style="text-align:center;">Nama Tipe Rekanan</th>
                      <th style="text-align:center;"> Aksi </th>
                      </tr>
                  </thead>
                  <tbody>

                    <?php $no=0; foreach($data_tipe_rekanan as $pkj) 
					{

					$no++ ?>
				<tr>
                      <td style="text-align:center;"><?php echo $no; ?></td>
					  <td style="text-align:left;"><?php echo ($pkj['no_tipe_rekanan']); ?></td>
					  <td style="text-align:left;"><?php echo ($pkj['nm_tipe_rekanan']); ?></td>
					  <td style="text-align:center;">
                      <a class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_edit<?php echo $pkj['no_tipe_rekanan']; ?>"><i class="fa fa-edit"></i></a>
                      <a onclick="return confirm('Anda Yakin Hapus Data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>cmastertiprek/hapus_item/<?php echo $pkj['no_tipe_rekanan']; ?>"><i class="glyphicon glyphicon-trash"></i></a>
...
<?php
        foreach($data_tipe_rekanan as $i){
