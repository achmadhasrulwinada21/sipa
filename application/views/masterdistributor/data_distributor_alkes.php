          ...
          <div class="row">
			...
			<input type="hidden" class="form-control" value="TP003" id="" name="id_tipe_produk" required readonly>
			    ...
			    <div class="form-group">
				 ...
				 <div class="col-lg-3">   
				     <div class="checkbox">
                      <label><input type="checkbox"  value="1" id="" name="principal">Principal</label>
				    ...
				    <div class="col-lg-3">   
				     <div class="checkbox">
                      <label><input type="checkbox"  value="1" id="" name="solo_agent">Solo agent</label>
				    ...
				    <div class="col-lg-3">    
				     <div class="checkbox">
                      <label><input type="checkbox"  value="1" id="" name="distributor">Distributor</label>
				    ...
				    <div class="col-lg-3"> 
				     <div class="checkbox">
                      <label><input type="checkbox"  value="1" id="" name="subdistributor">Subdistributor</label>
              ...
              <table id="tb-datatables" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a onclick="return confirm('Anda Yakin Hapus Data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>masterperusahaan/hapus_perusahaan_alkes/<?php echo $row['koper']; ?>"><i class="fa fa-close"></i></a>
