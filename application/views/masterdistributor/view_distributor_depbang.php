        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-md-12">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url(); ?>rpt_depbang/report_depbang" class="btn btn-danger no-radius dropdown-toggle"><i class="fa fa-print"></i> EXPORT DATA TO EXCEL </a>
              <div class="box">
