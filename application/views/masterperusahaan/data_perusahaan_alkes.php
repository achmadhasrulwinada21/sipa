    <!-- <ul class="nav nav-tabs">
	  ...
	  <li class="active"><a href="<?php echo base_url(); ?>masterperusahaan/dataperusahaan_alkes">Master Perusahaan Alkes</a></li>
	</ul> -->
  ...
  <?php
   $kodedara=($this->session->userdata('koderole'));
    ...
    <h1 style="text-align:center;">
       <b>  DATA MASTER PERUSAHAAN ALAT KESEHATAN </b>
        <small></small>
    </h1>
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-md-12">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url(); ?>Excel_import/peralkes" class="btn btn-warning no-radius dropdown-toggle"><i class="fa fa-folder-open"></i> IMPORT DATA FROM EXCEL </a>
			  <a style="margin-bottom:3px" href="<?php echo base_url(); ?>ci_to_excel/export_perush_alkes" class="btn btn-danger no-radius dropdown-toggle"><i class="fa fa-external-link"></i> EXPORT DATA TO EXCEL </a>
			...
			<div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>masterperusahaan/savedata_alkes" method="POST" enctype="multipart/form-data">
                  <div class="col-lg-12">
				  
				  
			<input type="hidden" class="form-control" value="TP003" id="" name="id_tipe_produk" required readonly>
			    <input type="hidden" class="form-control" value="ALKES" id="" name="tipe_produk" required readonly>
		          ...
		          <div class="form-group">
                      <label for="">Alamat</label> <a style="color: red;">*</a><br>
                        <textarea name="s_alamat" required class="form-control"></textarea>                        
                    </div>
                     <div class="form-group">
                      <label for="">Telepon</label> <a style="color: red;">*</a>
                        <input type="text" class="form-control" value="" id="" name="s_telp" placeholder="Isikan No Telpon" required>                        
                    </div>
					<div class="form-group">
                      <label for="">Fax</label> <a style="color: red;">*</a>
                        <input type="text" class="form-control" value="" id="" name="s_fax" placeholder="Isikan Fax" required>                        
                    </div>
                    <div class="form-group">
                      <label for="">Kontak</label> <a style="color: red;">*</a>
                        <input type="text" class="form-control" value="" id="" name="s_kontak" placeholder="Isikan Kontak" required>                        
                    </div>		
			
		       <div class="form-group">
		       	    <label for="">Email</label> <a style="color: red;">*</a>
                        <input type="text" class="form-control" value="" id="" name="s_email" placeholder="Isikan Email" required>                        
                    </div>
                    <div class="form-group"> 
			    ...
			    <div class="form-group">
				 ...
				 <div class="col-lg-3">   
                      ...
                      <label><input type="checkbox"  value="1" id="" name="principal" required>_Principal</label>
				    ...
				    <div class="col-lg-3">   
                      ...
                      <label><input type="checkbox"  value="1" id="" name="solo_agent" required>_Solo agent</label>
				    ...
				    <div class="col-lg-3">    
                      ...
                      <label><input type="checkbox"  value="1" id="" name="distributor" required>_Distributor</label>
				    ...
				    <div class="col-lg-3"> 
                      ...
                      <label><input type="checkbox"  value="1" id="" name="subdistributor" required>_Subdistributor</label>
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['nm_perusahaan']; ?></td>
					   <td style="text-align:center;"><?php echo $row['tipe_produk']; ?></td>
					    <td style="text-align:center;"><input type="checkbox" disabled="" <?php echo $c1= $row['principal']; if($c1=='1') echo " Checked "?>></td>
						<td style="text-align:center;"><input type="checkbox" disabled="" <?php echo $c1= $row['solo_agent']; if($c1=='1') echo " Checked "?>></td>
						<td style="text-align:center;"><input type="checkbox" disabled="" <?php echo $c1= $row['distributor']; if($c1=='1') echo " Checked "?>></td>
					     <td style="text-align:center;"><input type="checkbox" disabled="" <?php echo $c1= $row['subdistributor']; if($c1=='1') echo " Checked "?>></td>	   
                      <td style="text-align:center;">
					  <a href="<?php echo base_url(); ?>masterperusahaan/editmasterperusahaan_alkes/<?php echo $row['id_perusahaan']; ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                      ...
                      <a onclick="return confirm('Anda Yakin Hapus Data <?php echo $row['koper']; ?> ....??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>masterperusahaan/hapus_perusahaan_alkes/<?php echo $row['id_perusahaan']; ?>"><i class="fa fa-close"></i></a>
