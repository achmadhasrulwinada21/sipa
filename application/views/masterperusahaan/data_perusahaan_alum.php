   <!--  <ul class="nav nav-tabs">
	  ...
	  <li class="active"><a href="<?php echo base_url(); ?>masterperusahaan/dataperusahaan_alum">Master Perusahaan Alum</a></li>
  ...
  <?php
   $kodedara=($this->session->userdata('koderole'));
    ...
    <h1 style="text-align:center;">
       <b> DATA MASTER PERUSAHAAN ALAT UMUM </b>
        <small></small>
    </h1>
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-md-12">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url(); ?>Excel_import/peralum" class="btn btn-warning no-radius dropdown-toggle"><i class="fa fa-folder-open"></i> IMPORT DATA FROM EXCEL </a>
			  <a style="margin-bottom:3px" href="<?php echo base_url(); ?>ci_to_excel/export_perush_alum" class="btn btn-danger no-radius dropdown-toggle"><i class="fa fa-external-link"></i> EXPORT DATA TO EXCEL  </a>
			...
			<div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>masterperusahaan/savedata_alum" method="POST" enctype="multipart/form-data">
                  <div class="col-lg-12">
				  
				  
			<input type="hidden" class="form-control" value="TP002" id="" name="id_tipe_produk" required readonly>
			    <input type="hidden" class="form-control" value="ALUM" id="" name="tipe_produk" required readonly>
              ...
              <table id="tb-datatables" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
					  ...
					  <a href="<?php echo base_url(); ?>masterperusahaan/editmasterperusahaan_alum/<?php echo $row['id_perusahaan']; ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                      ...
                      <a onclick="return confirm('Anda Yakin Hapus Data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>masterperusahaan/hapus_perusahaan_alum/<?php echo $row['koper']; ?>"><i class="fa fa-close"></i></a>
