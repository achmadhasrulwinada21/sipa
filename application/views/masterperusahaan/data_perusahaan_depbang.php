        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-md-12">
			  ...
			  <a style="margin-bottom:3px" href="<?php echo base_url(); ?>Excel_import/perdepbang" class="btn btn-warning no-radius dropdown-toggle"><i class="fa fa-folder-open"></i> IMPORT DATA FROM EXCEL </a>
			...
			<input type="hidden" class="form-control" value="TP004" id="" name="id_tipe_produk" required readonly>
			    ...
			    <div class="form-group">
				   ...
				   <div  class="form-group">
					...
					<!--			   
				    <div class="form-group" >
                      <label for="">Bidang Pekerjaan</label> <a style="color: red;">*</a>
			    ...
			    <input type="hidden" class="form-control" value="" id="" name="bidang_pekerjaan" required readonly>-->
				   ...
				   <div class="col-lg-4">
				     ...
				     <div class="checkbox">
				      ...
				      <!--<div class="form-group">
                      <label for="">Keterangan</label> <a style="color: red;">*</a>
