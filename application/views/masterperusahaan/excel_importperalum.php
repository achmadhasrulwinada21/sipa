...
<html>
<head>
	<title>IMPORT DATA PERUSAHAAN ALUM</title>
...
<body>
	<div class="container">
		<div class="box">
		<br />
		<h3 align="center">IMPORT DATA PERUSAHAAN ALUM</h3><br><br>
		<form method="post" id="import_formperalum" enctype="multipart/form-data">
			<a style="margin-bottom:3px; margin-left: 5px" href="<?php echo base_url("download/perusahaan_alum.xlsx");?>" 
			...
			<input type="submit" name="import" value="Import" class="btn btn-warning no-radius dropdown-toggle" />
			 <a href="<?php echo base_url("masterperusahaan/dataperusahaan_alum"); ?>"></i> Kembali </a></p> </div>
		</form>
		<br />
		<div class="table-responsive" id="peralum_data">
			</div>
		</div>
	</div>
</body>
