...
<html>
<head>
	<title>IMPORT DATA PERUSAHAAN OBAT</title>
...
<body>
	<div class="container">
		<div class="box">
		<br />
		<h3 align="center">IMPORT DATA PERUSAHAAN OBAT</h3><br><br>
		<form method="post" id="import_formperobat" enctype="multipart/form-data">
			<a style="margin-bottom:3px; " href="<?php echo base_url("download/perusahaan_obat.xlsx");?>" 
			...
			<input type="submit" name="import" value="Import" class="btn btn-warning no-radius dropdown-toggle" />
			 <a href="<?php echo base_url("masterperusahaan"); ?>"></i> Kembali </a></p> </div>
		</form>
		<br />
		<div class="table-responsive" id="perobat_data">
			</div>
		</div>
	</div>
</body>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
		  ...
		  <br>
	      	<center>	
	        	 <img src="<?php echo base_url('assets/img/petunjuk.jpg'); ?>" alt="Hermina Hospital" class="img-responsive" >
	        </center>
