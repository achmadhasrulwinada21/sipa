<ul class="nav nav-tabs">
    <li class=""><a href="<?php echo base_url(); ?>Masterpt">Prinsipal</a></li>
     <li class=""><a href="<?php echo base_url(); ?>Masterpt/alum">ALUM</a></li>
     <li class="active"><a href="<?php echo base_url(); ?>Masterpt/alkes">ALKES</a></li>
 </ul> 
	 <section class="content-header">
    <h1 style="text-align:center;" >
        Master Perusahaan Alkes
        <small></small>
    </h1>
	...
	<section class="content">
          ...
          <section class="col-lg-12">
            ...
            <div class="box"> 		  
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>Masterpt/savedata_alkes" method="POST"  enctype="multipart/form-data">
                  <div class="col-lg-12">
           ...
           <!--  <input type="radio" name="tipe_produk" id="obat"  onclick="javascript:yesnoCheck();">PERUSAHAAN OBAT<br>
            ...
            <input type="radio" name="tipe_produk" id="alkes"  onclick="javascript:yesnoCheck();">PERUSAHAAN ALKES<br><br> -->
                    ...
                    <div class="form-group">
                      <label for="">Kode Alkes</label><br>
                        <input type="text" class="form-control"  value="" id="" name="alkesid" required> 
                             <br>
                      <br><label for="">Nama Alkes</label>
                         <input type="text" class="form-control"  value="" id="" name="alkesnama" required>                        
                   <br>
                      <label for="">Nama PT (Alkes)</label>
                        <input type="text" class="form-control"  value="" id="" name="pt_alkes" required>   
        ...
        <div style="text-align:center;" class="form-actions">
            ...
            <a href="<?php echo site_url('Masterpt/alkes')?>" class="btn"><i class="icon-remove-sign"></i> BATAL </a>
        </div>
    </form>
</div>
...
<div class="box-body"><br>
              ...
              <table id="datatables9" class="table table-bordered table-striped">
                  ...
                  <thead bgcolor="#DCDCDC" >
                    <tr>
                      ...
                      <th style="text-align:center;">Kode Alkes</th>
        ...
        <tr>         
            ...
            <td style="text-align:center;"><?php echo ($pkj['alkesid']); ?></td>
            <td style="text-align:left;"><?php echo ($pkj['alkesnama']); ?></td>
             <td style="text-align:left;"><?php echo ($pkj['pt_alkes']); ?></td>
           <!-- <td style="text-align:center;">
                      
                      <a onclick="return confirm('Anda Yakin Hapus Data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>Masterpt/hapus_alkes/<?php echo $pkj['idptalkes']; ?>"><i class="glyphicon glyphicon-trash"></i></a>
