<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php echo base_url(); ?>msesi">Master Kegiatan</a></li>  
  </ul> 
	...
	<section class="content">
          ...
          <section class="col-lg-12">
            ...
            <div class="box"> 		  
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>msesi/savedata" method="POST"  enctype="multipart/form-data">
                  <div class="col-lg-12">
                  ...
                  <div class="form-group">
                      <label for="">Nama Sesi</label>
                        <input type="text" class="form-control" value="" id="" name="nama_sesi"  required>
                    </div>
        ...
        <div style="text-align:center;" class="form-actions">
            ...
            <a href="<?php echo site_url('msesi')?>" class="btn"><i class="icon-remove-sign"></i> BATAL </a>
        </div>
    </form>
</div>
              ...
              <table id="tb-datatables" class="table table-bordered table-striped">
				...
				<tr>
					...
					<!--   <td style="text-align:center;"><?php //echo ($pkj['sesi']); ?></td> -->
					  <td style="text-align:left;"><?php echo ($pkj['nama_sesi']); ?></td>
             <td style="text-align:center;">
                      
                      <a onclick="return confirm('Anda Yakin Hapus Data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>msesi/hapus_item/<?php echo $pkj['idsesi']; ?>"><i class="glyphicon glyphicon-remove"></i></a>
					  </td>
					<?php } ?>
                  </tbody> 				  
        </table>
