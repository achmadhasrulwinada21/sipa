      ...
      <section class="content-header">
          ...
          <h1>
        NOTA PEMBAYARAN RENCANA KENDALI ANGGARAN RS BARU
        <small></small>
    </h1>
  ...
  <div class="col-md-12 clearfix">
    <ul id="example-tabs" class="nav nav-tabs" style="border-width:5px" data-toggle="tabs">
      ...
      <a href="<?php echo base_url(); ?>detailnota">Rencana Kendali Anggaran RS Baru</a></li>
      
      <li class="active" style="border:none; outline: none; cursor:pointer;background-color:#F0F8FF;">
      <a href="<?php echo base_url(); ?>notapembayaran">Nota Pembayaran Rencana Kendali RS Baru</a></li>
        </ul>             
  </div>
  </div>
          ...
          <?php endif;?>
            ...
            <td><?php echo $row['catatan']; ?></td>
                      <td>
                       ...
                       <!--  <td>
                      <a class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>notapembayaran/editnota/<?php echo $row['id_trnota']; ?>"><i class="glyphicon glyphicon-edit"></i></a> </td>
                      <?php if($this->session->userdata('koderole')=='18'):?>
                      <td>
                      <a onclick="return confirm('Hapus data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>notapembayaran/hapusnota/<?php echo $row['id_trnota']; ?>"><i class="glyphicon glyphicon-trash"></i></a>
