...
td{
	...
	<div class="col-md-12 clearfix">
		<ul id="example-tabs" class="nav nav-tabs" style="border-width:5px" data-toggle="tabs">
			...
			<a href="<?php echo base_url(); ?>perbarang">Form Surat</a></li>
			
			<li style="border:none; outline: none; cursor:pointer;background-color:#F0F8FF;">
			<a href="<?php echo base_url(); ?>detailbarang">Detail Barang</a></li>
	...
	<!--END MENU ATAS-->
                 ...
                 <table id="tb-datatables3" class="table table-bordered table-striped">
                  <thead>
                     <tr>
					  ...
					  <th style="vertical-align:middle;text-align:center" width="100">CATATAN MANAGER</th>
                  ...
                  <tbody>
                    ...
                    <tr>
					  ...
					  <td style="vertical-align:middle;text-align:center" width="80">
						<?php 
						if($dt['mengetahuidirekturcheck'] == "Approve") {
							echo '<p style="background-color:green;color:white;">Disetujui</p>';
						}elseif($dt['mengetahuidirekturcheck'] == "Not Approved"){
							echo '<p style="background-color:red;color:white;">Ditolak</p>';
						}elseif($dt['mengetahuidirekturcheck'] == "Revisi"){
							echo '<p style="background-color:blue;color:white;"><b>Revisi</b></p>';
						}else{
	  ...
	  <?php 
		$koderole=($this->session->userdata('koderole'));
		if($koderole!='1' && $koderole!='5' && $koderole!='10' && $koderole!='14' && $koderole!='15'):
	 ?> 
                    ...
                    <div class="form-group">
						...
						<thead>
							...
							<tr>
								...
								<th> : </th>
								<th> 
								<?php if($i['mengetahuidirekturcheck'] == "Approve") {
									echo '<b style="background-color:green;color:white;">Disetujui</b>';
										}elseif($i['mengetahuidirekturcheck'] == "Not Approved"){
									echo '<b style="background-color:red;color:white;">Ditolak</b>';
										}elseif($i['mengetahuidirekturcheck'] == "Revisi"){
									echo '<b style="background-color:blue;color:white;">Revisi</b>';
										}else{
									echo '<b style="background-color:gold;color:black;">Menunggu</b>';
										}
									?> 
								<br> 
								</th>
							...
							<tr>
							<th>-</th>
							<th style="color:blue;" width="120">Catatan Manager</th>
								<th width="10"> : </th>
