			...
			function ubahbulan($namabln)
{
	...
	break;
		...
		$html=' <table border="0">
					...
					<tr>
	<td style="text-align:center;font-size:14;font-weight:bold;">PT. MEDIKALOKA HERMINA Tbk<br>
		FORMULIR PERSETUJUAN DIREKSI
		<br>ATAS PERMINTAAN ALAT KESEHATAN INVESTASI STANDAR<br>
						</td></tr>
					</table><hr height="2px"/>
	    	 <b style="margin-bottom:4px;"></b> ';
					...
					<table border="1" cellspacing="0"  cellpadding="2">
                      ...
                      <th width="180" style="text-align:center;line-height:15px;"> Nama Produk </th>
					  <th width="130" style="text-align:center;line-height:15px;"> Merk </th>       
				...
				$html.='
					...
					<td width="25" align="center" style="line-height:15px;">'.$no.'</td>
						<td width="180" align="justify" style="line-height:15px;">'.$row->nama_produk.'</td>
						<td width="130" align="justify" style="line-height:15px;">'.$row->merk.'</td>
      ...
      $html.='<br><br>
                  <table border="0">
                   <tr>
                    <td width="100">Supplier</td><td width="10">:</td>
                    <td><b>'.$row->nm_perusahaan.'</b></td>
                    </tr>
                    <tr>
                   ...
                   <tr>
                    <td width="100"></td><td width="10"></td>
                    <td width="100">Telp. '.$row->s_telp.'</td> <td>Fax. '.$row->s_fax.'<br></td>
                   </tr>
                   <tr>
                    <td width="100">Harga Bayar</td><td width="10">:</td>
                    <td><b>Rp. '.number_format($row->grand_total).'</b><br></td>
                   </tr>
                   <tr>
                    <td width="100">RS Hermina yang meminta</td><td width="10">:</td>
                    <td>'.$row->namars.'</td>
                   </tr>
                  </table>
                   ';
                ...
                $html.='<br><br>
					...
					<tr>
					 ...
					 $html.='   <td width="120"> </td>
					    <td width="200"  align="left" style="line-height:80px;"><img src="assets/upload/'.$row->menyetujui.'" width="80px" height="50px"></td>
					</tr> </table>';
					...
					<table border="0">
						...
						<td width="200" align="left"></td>
						<td width="120"> </td>
						<td width="200" align="left"><u>'.$row->nm_menyetujui.'</u></td>
						</tr>
						<tr>
						<td width="100" align="left"></td>
						<td width="200" align="left"></td>
						<td width="120"> </td>
						<td width="200" align="left">'.$row->jb_menyetujui.'</td>
						</tr>
						</table>
										';
                                      }}
