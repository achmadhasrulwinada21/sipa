...
<?php
           ...
           <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>produko/savedata_alkesc" method="POST" enctype="multipart/form-data" id="multiple_select_form">
              ...
              <div class="col-lg-6">
                    ...
                    <input type="hidden" class="form-control" value="<?php echo $prod->pabrik_id ?>" id="" name="pabrikid"> 
                     <input type="hidden" class="form-control" value="<?php echo $prod->alkesid ?>" id="" name="alkesid"> 
                           <?php 
                         $a=$prod->tipe_produk;
                   if($a=='OBAT'):  
                   ?>
          ...
          <?php 
                   ...
                   <div class="form-group" >
                      <label for="">NAMA PRODUK (ALKES)</label>
                        <select id="alkesid" name="alkespbkid" class="form-control" required>
                          <option value="-">--Pilih Tipe Produk--</option>
           ...
           <!-- <?php  // foreach($data_abk as $row) { ?> -->
              ...
              <td style="text-align: center;">Rp.<?php echo number_format($row['harga'], 2,',','.'); ?></td>
                     ...
                     <!--  <a style="margin-bottom:3px;" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal_edit<?php //echo $row['iddetailprod'];?>"><i class="glyphicon glyphicon-remove"></i></a> -->
                      ...
                      <a  style="margin-bottom:3px;" onclick="return confirm('Hapus data beserta detail??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>produko/hapusdetailalkes/<?php echo $row['iddetailprod']; ?>/<?php echo $row['koded_prod']; ?>/<?php echo $row['alkesid']; ?>"><i class="glyphicon glyphicon-remove"></i></a>
                     </td>
