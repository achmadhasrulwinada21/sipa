...
<link rel="stylesheet" href="<?php echo base_url('assets/css/select2.min.css') ?>"/>	    
 <section class="content-header">
    ...
    <li class=""><a href="<?php echo base_url(); ?>produko/alkes">Data Produk alkes</a></li>
     <li class="active"><a href="<?php echo base_url(); ?>produko/alum">Data Produk alum</a></li>
            ...
            <div class="box">       
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                  ...
                  <form role="form" action="<?php echo base_url(); ?>produko/savedatas_alum" method="POST"  enctype="multipart/form-data">
                  <div class="col-lg-12">
                    ...
                    <div class="form-group" hidden>
                      <label for="">TIPE PRODUK</label>
                        <select name="tipe_produk" class="form-control" required>
                          <option value="ALUM">--Pilih Tipe Produk--</option>
             ...
             <div class="form-group">
                      <label for="foto">NAMA ALUM</label>
                       <br>
                        <select id="alumid" name="alumid" class="form-control" required>
                          <option value="-">pilih alum</option>
                          <?php foreach($kode_alum as $row) { ?>
                              <option value="<?php echo $row['alumid'] ?>"><?php echo $row['pt_alum'] ?></option>
                          <?php } ?>
              </select>

               <input type="hidden" class="form-control" value="-" id="" name="pt_alum" required readonly>
              <input type="hidden" class="form-control" value="-" id="" name="alumnama" required readonly>
                
                      <label for="">DISTRIBUTOR</label>
                        <input type="text" class="form-control" value="-" id="" name="distalumid" required readonly>
            </div>
                ...
                <div class="box-body">
                  ...
                  <thead>
                    <tr align="center" class="danger">
                      ...
                      <th style="vertical-align: middle;text-align: center;">NAMA ALUM</th>
                  ...
                  <tbody>
                   <?php $no=0;
                    ...
                    <tr>
                      ...
                      <td><a data-toggle="modal" href="#modal_edit<?php echo $row['idpr']; ?>"><?php echo $row['prid']; ?></a></td>
                       ...
                       <td><?php echo $row['pt_alum']; ?></td>
                       <td><?php echo $row['distalumid']; ?></td>
                   ...
                   if($kode !='10' and $kode !='15' ):?>
                       <td style="vertical-align: middle;text-align: center;">
                        ...
                        <a style="margin-bottom:3px;" class="btn btn-success btn-sm" href="<?php echo base_url(); ?>produko/adddetail_alumc/<?php echo $row['idpr']; ?>/<?php echo $row['alumid']; ?>"><i class="fa fa-plus">&nbsptambah detail</i></a> 
                 ...
                 <!--  <a style="margin-bottom:3px;" class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>produko/editproduko/<?php echo $row['idpr']; ?>"><i class="glyphicon glyphicon-edit"></i></a>  -->
                      <a  style="margin-bottom:3px;" onclick="return confirm('Hapus data beserta detail??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>produko/hapusprodalum/<?php echo $row['idpr']; ?>"><i class="glyphicon glyphicon-remove"></i></a> 
                     </td><?php endif;?>
                    </tr>
                              <?php
    ...
    $prod = $this->db->get_where('v_produko',['idpr'=>$idpr])->row();
        ...
        ?>
               ...
               <table style="margin-bottom:3px;margin-left: 7px;margin-top: 5px;">
                   <tr>   <td width="200">NAMA PRINSIPAL</td><td width="10">:</td><td width="300"><?php echo $prod->pt_alum ?></td></tr>
