 ...
 <section class="content-header">
        ...
        <section class="content">
          <!-- Small boxes (Stat box) -->
           <ul class="nav nav-tabs">
    <li class="active"><a href="<?php echo base_url(); ?>produko">Data Produk Obat</a></li>
    <li class=""><a href="<?php echo base_url(); ?>produko/alkes">Data Produk alkes</a></li>
            ...
            <div class="box">       
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                  ...
                  <form role="form" action="<?php echo base_url(); ?>produko/savedatas" method="POST"  enctype="multipart/form-data">
                  <div class="col-lg-12">
                      ...
                      <label for="foto">NAMA PRINSIPAL</label>
                        ...
                        <select id="pabrik_id" name="pabrik_id" class="chosen" required>
                          ...
                          <?php foreach($kode_pabrik as $row) { ?>
                              <option value="<?php echo $row['pabrik_id'] ?>"><?php echo $row['nama_pt'] ?></option>
                          <?php } ?>
						  </select><br><br>

               <input type="hidden" class="form-control" value="-" id="" name="nama_pt" required readonly>
              <input type="hidden" class="form-control" value="-" id="" name="pabriknama" required readonly>
           ...
           <!-- <?php  // foreach($data_abk as $row) { ?> -->
                ...
                <div class="box-body">
                   ...
                   <?php $no=0;
                    ...
                    <tr>
                     ...
                     <!-- <td><a data-toggle="modal" href="#modal_edit<?php echo $row['idpr']; ?>"><?php echo $row['prid']; ?></a></td> -->
                       ...
                       <td><a data-toggle="modal" href="#modal_edit<?php echo $row['idpr']; ?>"><?php echo $row['nama_pt']; ?></a></td>
                       <td><?php echo $row['s_kode']; ?></td>
                        <?php
                    $kode=($this->session->userdata('koderole'));
                   if($kode !='10' and $kode !='15' ):?>
					             <td style="vertical-align: middle;text-align: center;">
                        <a style="margin-bottom:3px;" class="btn btn-success btn-sm" href="<?php echo base_url(); ?>produko/adddetail/<?php echo $row['idpr']; ?>/<?php echo $row['pabrik_id']; ?>"><i class="fa fa-plus">&nbsptambah detail</i></a> 
                        <a style="margin-bottom:3px;" target="blank" class="btn btn-info btn-sm" href="<?php echo base_url(); ?>Laporanprodukob/cetak_produkob/<?php echo $row['idpr']; ?>/<?php echo $row['pabrik_id']; ?>"><i class="fa fa-print">&nbspPRINT</i></a>                      
                  <a style="margin-bottom:3px;" class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>produko/editproduko/<?php echo $row['idpr']; ?>"><i class="glyphicon glyphicon-edit"></i></a> 
                      <a  style="margin-bottom:3px;" onclick="return confirm('Hapus data beserta detail??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>produko/hapusprod/<?php echo $row['idpr']; ?>"><i class="glyphicon glyphicon-remove"></i></a>
                     </td>
                     <?php endif;?> 
                    </tr>
                              <?php
...
<div id="modal_edit<?php echo $idpr;?>" class="modal fade">
  ...
  <div class="panel panel-success">
    ...
    $tampil= $this->produkom->Getprodukms2("where koded_prod='$idpr' order  by createdate asc")->result_array();
