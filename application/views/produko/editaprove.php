          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>produko/updateaprove" method="POST" enctype="multipart/form-data">
               ...
               <label type="hidden" for="">TTD Menyetujui</label>
                  ...
                  <a href="<?php echo base_url(); ?>produko/aprove" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div>
                </div><!-- /.item -->
