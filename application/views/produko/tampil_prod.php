...
form.example::after {
 ...
 <section class="content-header">
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-md-12">
                     <a href="<?php echo site_url('produko')?>" class="btn btn-success" style="margin-bottom:6px"><i class="glyphicon glyphicon-home"></i>&nbspKEMBALI</a> 
           ...
           <!-- <?php  // foreach($data_abk as $row) { ?> -->
             ...
             <?php endif;?>
              <td style="text-align: center;"><?php echo $row['harga']; ?></td>
                 ...
                 <table style="margin-bottom:3px;margin-left: 7px;margin-top: 5px;">
                   <tr  bgcolor="skyblue">  <td width="140"><b>JUMLAH PRODUK</b></td><td width="10">:</td><td width="10"><b> <?php echo count($data_prod); ?></b></td></tr>
                   </tr>
                    <!-- <?php// } ?> -->
                 </table>
               </div>
