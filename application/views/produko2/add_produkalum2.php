<section class="content-header">
 ...
 <div class="box">
                ...
                <?php
                   ...
                   if($kode !='10' and $kode !='52' and $kode!='82' ):?>
            ...
            <?php endif;?>
              ...
              <a style="margin-top:5px;" class="btn btn-success btn-md" href="<?php echo base_url(); ?>produko2/lihattralum/<?php echo $prod->kode_th ?>/<?php echo $prod->tanggal_tr ?>"><i class="glyphicon glyphicon-home"></i>&nbsp KEMBALI</a><br>
                <!-- chat item -->
                    <?php endif;?>
                <div class="item">
                     <?php
                    $kode=($this->session->userdata('koderole'));
                   if($kode !='10' and $kode !='52' and $kode!='82'):?>
                  <form role="form" form name="form1"  action="<?php echo base_url(); ?>produko2/savedata_alumc" method="POST" enctype="multipart/form-data" id="multiple_select_form">
				    ...
				    <div class="form-group" >
                     ...
                     <div class="form-group">
                      <label for="">KETERANGAN</label>
                       <input type="text" class="form-control" value="" name="garansi_ket" id="" placeholder="keterangan" autocomplete="off" />                 
                    </div> 
					</div>-->
 ...
 <div class="form-group">
                      <label for="">Keterangan</label>
					   <textarea rows="4" cols="54" class="form-control" name="ket" placeholder="Keterangan"></textarea>              
                    </div>
                     
					 <div class="form-group">
                      <label for="">Catatan</label>
					   <textarea rows="4" cols="54" class="form-control" name="note" placeholder="Catatan"></textarea>
                    </div> 

                     <div class="form-group">
                      <label for="">Contact Person</label>
					  <textarea rows="4" cols="54" class="form-control" name="contact" placeholder="Contact Person"></textarea>
                    </div>
            ...
            <button onclick="return confirm('Apakah Data Detail Sudah Terisi ?... ');" type="submit" class="btn btn-success"><i class="icon-ok-sign icon-white"></i> SIMPAN </button>
              <a href="<?php echo base_url(); ?>produko2/addtralum/<?php echo $prod->kode_th ?>/<?php echo $prod->tanggal_tr ?>" class="btn"><i class="icon-remove-sign"></i> BATAL </a>
             </div></div></div>
                <!-- /.col -->
               </form>
                 <?php endif;?>
         ...
         <div class="panel panel-primary"></div>
           ...
           <!-- <?php  // foreach($data_abk as $row) { ?> -->
                ...
                <div class="box-body">
                  ...
                  <table id="tb-datatables" class="table table-bordered table-striped table-havor">
                  <thead>
		   ...
		   <td style="vertical-align: middle;text-align: center;"><?php echo $tr['contact']; ?></td>
             <td style="vertical-align: middle;text-align: center;">   
              <?php
                    $kode=($this->session->userdata('koderole'));
                   if($kode !='10' and $kode !='52' and $kode !='82'):?>
           <a style="margin-bottom:3px;" class="btn btn-info btn-sm" href="<?php echo base_url(); ?>produko2/editabksalum/<?php echo $tr['iddetilalum']; ?>/<?php echo $tr['koper']; ?>"><i class="glyphicon glyphicon-edit"></i></a>
                      <a  style="margin-bottom:3px;" onclick="return confirm('Hapus data beserta detail??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>produko2/hapusdetailalum/<?php echo $tr['iddetilalum']; ?>/<?php echo $tr['kode_tr']; ?>/<?php echo $tr['koper']; ?>"><i class="glyphicon glyphicon-remove"></i></a>
                      <?php endif; ?>
                       <?php
                    $dara=($this->session->userdata('koderole'));
                   if($dara =='10' or $dara =='52' or $dara =='82'):?>
  ...
  <div class="panel panel-primary">
       <div class="panel-heading">
        ...
        <div class="modal-body">
                  <form role="form" action="<?php echo base_url(); ?>produko2/updaterejectdetil2" method="POST" enctype="multipart/form-data">
                  <div class="col-md-6">
