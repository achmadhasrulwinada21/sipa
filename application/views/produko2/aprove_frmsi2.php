<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php echo base_url(); ?>produko2/aprove">Perbandingan Produk Ecatalog</a></li>
            ...
            <div class="box"> 	<br>
              <?php
                   ...
                   if($kode !='10' and $kode !='15' ):?>
                          <b style="margin-left:4%"><a href="<?php echo base_url(); ?>produko2/aprove_kadep"><span class=" btn btn-warning">Disetujui Kadep</span></a></b>
                           <a href="<?php echo base_url(); ?>produko2/aprove_selesai"><span class=" btn btn-success">Disetujui Direktur</span></a>

              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>produko2/savedata_aprove" method="POST"  enctype="multipart/form-data">
                  <div class="col-lg-12">
           ...
           <div class="box-body table-responsive">
             ...
             <td style="text-align:center;"> 
                 <?php
                    $kode=($this->session->userdata('koderole'));
                   if($kode !='10' and $kode !='15' ):?>
              <a style="margin-bottom:3px;" class="btn btn-success btn-sm" href="<?php echo base_url(); ?>produko2/aprove_detail/<?php echo $pkj['idtrcom']; ?>"><i class="fa fa-plus">&nbsptambah detail</i></a> 
              <?php endif;?> 
                <?php
                    $kode=($this->session->userdata('koderole'));
                   if($kode =='10' or $kode =='15' or $kode =='1' ):?>
               <a style="margin-bottom:3px;" class="btn btn-success btn-sm" href="<?php echo base_url(); ?>produko2/editaprove/<?php echo $pkj['idtrcom']; ?>"><i class="fa fa-edit">&nbspedit</i></a> 
                        <?php endif;?>
                <a style="margin-bottom:3px;" target="blank" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>LaporanCompare2/cetak_compare_obat2/<?php echo $pkj['idtrcom']; ?>"><i class="fa fa-print">&nbspPRINT</i></a> 
             </td>
            <?php } ?>
                  </tbody> 				  
        </table>
