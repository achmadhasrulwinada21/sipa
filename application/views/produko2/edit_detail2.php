          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>produko2/updateabksd" method="POST" enctype="multipart/form-data">
                     <div class="col-lg-6">                  
                  ...
                  <input type="hidden" class="form-control" value="<?php echo $koper;?>" name="koper">
                     ...
                     <div class="form-group">
                      <label for="">NAMA PRODUK (OBAT)</label><br>
                       <select id="kode_produk" name="kode_produk" class="chosen">
               ...
               <input type="hidden" class="form-control" value="<?php echo $nama_produk; ?>" name="nama_produk" id="" placeholder="nama produk"/>   
                       <div class="form-group">
          <label for="">KOMPOSISI</label>
           <input type="text" class="form-control" value="<?php echo $deskripsi; ?>" name="deskripsi" id="" placeholder="komposisi"/>
             </div>				
	<div class="form-group">
          <label for="">Distributor</label>
					 <input type="text" class="form-control" value="<?php echo $kodis; ?>" name="kodis" id="" placeholder="nama produk"/>
	           </div>
...
<div class="col-lg-6">
                  ...
                  <a href="<?php echo base_url(); ?>produko2/adddetail/<?php echo $koded_prod; ?>/<?php echo $koper; ?>" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div>
                </div><!-- /.item -->
