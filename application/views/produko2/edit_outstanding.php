          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                  <form role="form" form name="form1"  action="<?php echo base_url(); ?>produko2/updateoutstanding" method="POST" enctype="multipart/form-data">
                     <div class="col-lg-12">                  
                  ...
                  <a href="<?php echo base_url(); ?>produko2/lihattralumhistori" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div>
                </div><!-- /.item -->
