          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>produko2/updatereject" method="POST" enctype="multipart/form-data">

                  <?php
                          $dara=($this->session->userdata('koderole'));
                   if($dara =='10' || $dara =='52' || $dara =='53' || $dara =='1' || $dara =='82'):?>
                   <input type="hidden" class="form-control" value="<?php echo $idtrcom;?>" name="idtrcom">
                       <input type="hidden" class="form-control" value="TP002" id="" name="id_tipe_produk">
                 ...
                 <input type="hidden" class="form-control" value="4" id="" name="status">
                  ...
                  <a href="<?php echo base_url(); ?>produko2/alum" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div>
                </div><!-- /.item -->
