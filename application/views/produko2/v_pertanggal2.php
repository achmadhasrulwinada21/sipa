          ...
          <div class="row">
            ...
            <div class="box">       
              <div class="box-body chat" id="chat-box">
                ...
                <a style="margin-bottom:3px" href="<?php echo base_url(); ?>produko/compare"class="btn btn-primary no-radius dropdown-toggle"><i class="fa fa-home"></i>&nbspKembali</a>
         ...
         <!-- <a style="margin-bottom:3px;margin-left: 7px;" href="<?php //echo base_url(); ?>produko/addabk" class="btn btn-info no-radius dropdown-toggle"><i class="glyphicon glyphicon-plus"></i> TAMBAH</a> -->
           <!-- <?php  // foreach($data_abk as $row) { ?> -->
                ...
                <div class="table-responsive box-body">
                   ...
                   <a style="margin-bottom:3px" href="<?php echo base_url(); ?>LaporanCompare/cetak_compare_obat" target='blank' class="btn btn-primary no-radius dropdown-toggle"><i class="fa fa-print"></i> PRINT ALL </a>
                    <a data-toggle="modal" data-target="#myModal" class="btn btn-success"><i class="fa fa-print"></i> PRINT BY TANGGAL </a>
                    <a data-toggle="modal" data-target="#myModal2" class="btn btn-danger"><i class="fa fa-print"></i> LIHAT BY TANGGAL </a>
                  ...
                  <thead>
                    <tr align="center" class="danger">
					  ...
					  <th style="vertical-align: middle;text-align: center;"> PKS Renewal MMF </th>
                  ...
                  <tbody>
                   <?php $no=0;
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;"><?php echo $row['pks_renewal']; ?></a></td>
                     <!-- <td>
					...
					<!--
                     ...
                     <a style="margin-bottom:3px;" class="btn btn-info btn-sm" href="<?php echo base_url(); ?>produko/editproduko/<?php echo $row['idpr']; ?>"><i class="glyphicon glyphicon-edit"></i></a> 
                     -->
					 <!--<a  style="margin-bottom:3px;" onclick="return confirm('Hapus data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>produko/hapusprod/<?php echo $row['idpr']; ?>"><i class="glyphicon glyphicon-trash"></i></a>
                     </td>-->
                    </tr>
                              <?php
       ...
       <div class="panel-heading">
        ...
        <div class="modal-body">
          <?php 
              ...
              if (isset($idpr)&&isset($tanggal)) {
      
    $tampil_kurang_ecat= $this->produkom->Getprodukm("where idpr=$idpr AND tipe_harga='Jumlah <= E-Cat'  AND hapus =0 AND tanggal ='$tanggal'")->result_array();
               ...
               <table style="margin-bottom:3px;margin-left: 7px;margin-top: 5px;">
                   <tr>   <td width="200">NAMA PRINSIPAL</td><td width="10">:</td><td width="300"><?php echo $prod->nama_pt ?></td></tr>
                     <tr>  <td width="200">NAMA DISTRIBUTOR</td><td width="10">:</td><td width="300"><?php echo $prod->s_kode ?> </td></tr>
                        <tr>  <td width="200">TANGGAL ENTRY</td><td width="10">:</td><td width="300"><?php echo $tanggal_awal ?> </td></tr>        
...
<div id="modal_edit2<?php echo $idpr;?>" class="modal fade">
  ...
  <div class="panel panel-success">
    ...
    $tampil_kurang_ecat= $this->produkom->Getprodukm("where idpr=$idpr AND tipe_harga='Jumlah = E-Cat' AND hapus =0 AND tanggal ='$tanggal' order  by idpr asc")->result_array();
    $prod = $this->db->get_where('v_produko',['idpr'=>$idpr])->row();
...
<div id="modal_edit3<?php echo $idpr;?>" class="modal fade">
  ...
  <div class="panel panel-success">
    ...
    $tampil_kurang_ecat= $this->produkom->Getprodukm("where idpr=$idpr AND tipe_harga='Jumlah < 10 % E-Cat'  AND hapus =0 AND tanggal ='$tanggal' order  by idpr asc")->result_array();
    $prod = $this->db->get_where('v_produko',['idpr'=>$idpr])->row();
