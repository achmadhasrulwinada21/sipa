	<section class="content-header">
        <h4 style="text-align: center;">
          <b><span> Data Produk alkes Out Standing<br>
          </span></b>
        </h4>
        </section>
          ...
          <div class="row">
            ...
            <div class="box">       
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                 <a style="margin-top:5px;" class="btn btn-success btn-md" href="<?php echo base_url(); ?>Alkestransaksi"><i class="glyphicon glyphicon-home"></i>&nbsp KEMBALI</a><br>
                <div class="item">
            ...
            <div  class="col-md-12">
                ...
                <div class="table-responsive">
                  <table id="table65" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
                <tr bgcolor="#4682B4" style="font-family: arial; color: white;">
                  ...
                  <th style="vertical-align: middle; text-align: center;">Nama Produk</th>
                    ...
                    $kode=($this->session->userdata('koderole'));
                     if($kode !='10' and $kode !='69' and $kode !='57' and $kode !='82'): ?>
                    <th style="vertical-align: middle; text-align: center;">Update</th>
                  <?php endif; ?>
				  <?php
				  $kode=($this->session->userdata('koderole'));
				  if($kode !='75' and $kode !='76' ): ?>
...
<?php
      foreach($data_prod as $i){
       $iddetailalkes = $i['iddetailalkes'];        
         ?>

<div id="modal_edit<?php echo $iddetailalkes;?>" class="modal fade">
  ...
  <div class="panel panel-danger">
       <div class="panel-heading">
        ...
        <div class="modal-body modal-lg">
          ...
          if (isset($iddetailalkes)) {
      
    $tampil= $this->produkom2->Getprodukms2alkes("where iddetailalkes='$iddetailalkes' and (statusdetil='1'
      or statusdetil='01' or statusdetil='2' or statusdetil='3' or statusdetil='4'  or statusdetil='82')")->result_array();
    $prod = $this->db->get_where('v_detail_alkes2',['iddetailalkes'=>$iddetailalkes])->row();

    }
        ?>
                        <?php include 'tampil_produkalkeshistori.php';?>
...
<?php
        foreach($data_prod as $i){
       $iddetailalkes=$i['iddetailalkes'];
      $kode_alkes = $i['kode_alkes'];
      $kode_trans = $i['kode_trans'];
      $koper = $i['koper'];
      $nama_produk = $i['nama_produk'];
       ?>
<div id="modal_edits<?php echo $iddetailalkes;?>" class="modal fade">
  ...
  <div class="panel panel-primary">
       <div class="panel-heading">
        ...
        <div class="modal-body">
                  <form role="form" action="<?php echo base_url(); ?>produko2/updateaprovedetil2" method="POST" enctype="multipart/form-data">
                  <div class="col-md-6">
                     <input type="hidden" class="form-control" value="<?php echo $iddetailalkes;?>" id="" name="idpr2">
                      <input type="hidden" class="form-control" value="<?php echo $kode_trans;?>" id="" name="kode_trans">
                      <input type="hidden" class="form-control" value="<?php echo $kode_alkes;?>" id="" name="kode_alkes">
...
<?php
      ...
      $nama_produk = $i['nama_produk'];
       ?>
<div id="modal_editss<?php echo $iddetailalkes;?>" class="modal fade">
  <div class="modal-dialog modal-md">
    <!-- <div class="modal-content"> --> 
  <div class="panel panel-primary">
       <div class="panel-heading">
        ...
        <div class="modal-body">
                  <form role="form" action="<?php echo base_url(); ?>produko2/updaterejectdetil21" method="POST" enctype="multipart/form-data">
                  <div class="col-md-6">
                     <input type="hidden" class="form-control" value="<?php echo $iddetailalkes;?>" id="" name="idpr2">
                      <input type="hidden" class="form-control" value="<?php echo $kode_trans;?>" id="" name="kode_trans">
                      <input type="hidden" class="form-control" value="<?php echo $kode_alkes;?>" id="" name="kode_alkes">
