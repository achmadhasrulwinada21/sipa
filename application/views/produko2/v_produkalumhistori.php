	<section class="content-header">
        <h4 style="text-align: center;">
          <b><span> Data Produk Alum Out Standing<br>
          </span></b>
        </h4>
        </section>
          ...
          <div class="row">
            ...
            <div  class="col-md-12">
                ...
                <div class="table-responsive">
                  <table id="table64" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
...
<div id="modal_edit<?php echo $iddetilalum;?>" class="modal fade">
  ...
  <div class="panel panel-danger">
    ...
    $prod = $this->db->get_where('v_produkoalum',['iddetilalum'=>$iddetilalum])->row();

    }
        ?>
                        <?php include 'tampil_produkalumhistori.php';?>
