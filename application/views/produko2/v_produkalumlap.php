 ...
 <section class="content-header">
        <h4 style="text-align: center;">
          <b><span>RR-LISTING DATA PRODUK ALUM<br>
          ...
          <div class="row">
            ...
            <div class="box">       
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                 <form role="form" action="<?php echo base_url(); ?>lapalum/expor_detilalum" method="POST"  enctype="multipart/form-data" target="blank">
            ...
            <button  type="submit" class="btn btn-info"><i class="fa fa-print"></i> PRINT </button>
                 ...
                 <a class="btn btn-success btn-md" href="<?php echo base_url(); ?>produko2/cetaklum"><i class="glyphicon glyphicon-home"></i>&nbsp KEMBALI</a><br>
                <div class="item">
