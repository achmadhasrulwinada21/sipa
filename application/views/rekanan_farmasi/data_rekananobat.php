...
<link rel="stylesheet" href="<?php echo base_url('assets/css/select2.min.css') ?>"/>
 ...
 <section class="content-header">
        <h4 style="text-align: center;">
          <b><span> DATA REKANAN OBAT</span></b>
        </h4>
        </section>
       ...
       <!--  <a style="margin-bottom:3px" href="<?php echo base_url("index.php/C_rekananobat/form"); ?>" class="btn btn-warning no-radius dropdown-toggle">
        <i class="glyphicon glyphicon-download-alt"></i> IMPORT DATA FROM EXCEL </a> -->

        <a style="margin-bottom:3px" href="<?php echo base_url('C_rekananobat/v_export_excel') ?>" class="btn btn-danger no-radius dropdown-toggle">
