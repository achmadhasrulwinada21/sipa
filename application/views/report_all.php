 ...
 header("Content-Disposition: attachment; filename=cetak_rekanan_all.xls");
 ...
 ?>
  <h4 style="text-align: center;">
          <b><span>Laporan Database Rekanan (ALL KATEGORI)<br>
  ...
  <?php                      
   ...
   <td style="text-align: left;"><?php echo $row['tipe_produk']; ?></td>
...
<!--
		<table border="0">
				   ...
				   <table border="0">
					<tr>
					<td width="30"> </td>
					<td rowspan="5" hight="200" align="left">dasdasdsd</td>
					
					<td rowspan="5" hight="200" align="left">asdasdasdasd</td>
					</tr>
                   </table>
