 ...
 header("Content-Disposition: attachment; filename=cetak_rekanan_depbang.xls");
 ...
 ?>
  <h4 style="text-align: center;">
          <b><span>Laporan Database Rekanan Departemen Pembangunan<br>
      ...
      <?php
		...
		<table border="0">
				   ...
				   <table border="0">
					...
					<td rowspan="5" hight="200" align="left">Yulisar Khiat</td>
					</tr>
                   </table>
					...
					<tr>
					<td width="30"> </td>
					<td width="100" align="left">Kepala Departemen Pembangunan</td>
