        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <i class="fa fa-plus"></i>
                      <h3 class="box-title"> A. FORM ISIAN PERMOHONAN STPD</h3>
                    </div>
...
<!-- 
                      ...
                      <input type="text" class="form-control"  name="namakadep" placeholder="Nama Kepala Departemen">  
                    </div> -->
                    <!--    <div class="form-group">
...
<!-- 
                 ...
                 Note(Penting) : Yang mengisi permohonan sekretaris departemen
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo site_url('stpd'); ?>" class="btn btn-primary">Kembali</a>
                    </div>
                </form>
                </div>
            </div>
