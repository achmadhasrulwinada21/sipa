          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              <div class="box-header">
                ...
                <h3 class="box-title">FORM TAMBAH TRANSAKSI EKSEKUTIF REPORT I(REAL)</h3>
              </div>
              <div class="box-body chat" id="chat-box"> 
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>transaksi/insert_keDB" method="POST" enctype="multipart/form-data">
                 <div class="col-lg-6">
...
<table id="options-table">
 ...
 <td><input type="text"  placeholder="" value="Nilai"  style="height:40px;width:110px;text-align: center;font-weight:bold;" readonly=""></td> 
  ...
  <td><input type="text" name="TT[]" placeholder="" value="0"  style="height:40px;width:110px;" readonly="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="" placeholder="" value="P.Margin(%)"  style="height:40px;width:170px;"/></td> 
...
<table id="options-table">
 ...
 <td><input type="text"  placeholder="" value="Nilai"  style="height:40px;width:110px;text-align: center;font-weight:bold;" readonly=""></td> 
  ...
  <tr>
     ...
     <td><input type="text" placeholder="" value="23"  style="height:40px;width:40px;font-weight:bold;" readonly=""></td>
  ...
  <tr>
     ...
     <td><input type="text" placeholder="" value="24"  style="height:40px;width:40px;font-weight:bold;" readonly=""></td>
 ...
 <tr>
     ...
     <td><input type="text" placeholder="" value="25"  style="height:40px;width:40px;font-weight:bold;" readonly=""></td>
  ...
  <tr>
     ...
     <td><input type="text" placeholder="" value="26"  style="height:40px;width:40px;font-weight:bold;" readonly=""></td>
  ...
  <tr>
     ...
     <td><input type="text" placeholder="" value="27"  style="height:40px;width:40px;font-weight:bold;" readonly=""></td>
  ...
  <tr>
     ...
     <td><input type="text" placeholder="" value="28"  style="height:40px;width:40px;font-weight:bold;" readonly=""></td>
  ...
  <tr>
     ...
     <td><input type="text" placeholder="" value="29"  style="height:40px;width:40px;font-weight:bold;" readonly=""></td>
