          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              <div class="box-header">
                ...
                <h3 class="box-title">FORM EDIT TRANSAKSI EKSEKUTIF REPORT I(TARGET)</h3>
              </div>
              <div class="box-body chat" id="chat-box"> 
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>transaksiacuan/updatetransaksieksdiracuan" method="POST" enctype="multipart/form-data">
                 <div class="col-lg-6">
...
<table id="options-table">
 ...
 <td><input type="text"  placeholder="" value="Nilai"  style="height:40px;width:110px;text-align: center;font-weight:bold;" readonly=""></td> 
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian1 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian2 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian3 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="%" value="<?php echo $nilai_uraian4 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian5 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder=""  value="<?php echo $nilai_uraian6 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder=""  value="<?php echo $nilai_uraian7 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder=""  value="<?php echo $nilai_uraian8 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder=""  value="<?php echo $nilai_uraian9 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder=""  value="<?php echo $nilai_uraian10 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="%"  value="<?php echo $nilai_uraian11 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder=""  value="<?php echo $nilai_uraian12 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder=""  value="<?php echo $nilai_uraian13 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder=""  value="<?php echo $nilai_uraian14 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian15 ?>"  style="height:40px;width:110px;text-align: center;"/></td> 
</tr>
...
<table id="options-table">
 ...
 <td><input type="text"  placeholder="" value="Nilai"  style="height:40px;width:110px;text-align: center;font-weight:bold;" readonly=""></td> 
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian16 ?>"  style="height:40px;width:110px;text-align: center;" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian17 ?>"  style="height:40px;width:110px;text-align: center;" required="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian18 ?>"  style="height:40px;width:110px;text-align: center;" required="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian19 ?>"  style="height:40px;width:110px;text-align: center;" required="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian20 ?>"  style="height:40px;width:110px;text-align: center;" required="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian21 ?>"  style="height:40px;width:110px;text-align: center;" required="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="%" value="<?php echo $nilai_uraian22 ?>"  style="height:40px;width:110px;text-align: center;" required="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="%" value="<?php echo $nilai_uraian23 ?>"  style="height:40px;width:110px;text-align: center;" required="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian24 ?>"  style="height:40px;width:110px;text-align: center;" required="" /></td> 
</tr>
 ...
 <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian25 ?>"  style="height:40px;width:110px;text-align: center;" required="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="%" value="<?php echo $nilai_uraian26 ?>"  style="height:40px;width:110px;text-align: center;" required="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian27 ?>"  style="height:40px;width:110px;text-align: center;"required="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian28 ?>"  style="height:40px;width:110px;text-align: center;"required="" /></td> 
</tr>
  <tr>
  ...
  <td><input type="text" name="TT[]" placeholder="" value="<?php echo $nilai_uraian29 ?>"  style="height:40px;width:110px;text-align: center;" required="" /></td> 
</tr>
