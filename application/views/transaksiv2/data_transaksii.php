      ...
      <section class="content-header">
        ...
        <section class="content">
          ...
          <div class="row">
			...
			<a  style="margin-bottom:3px" href="<?php echo base_url(); ?>transaksii/addtransaksi" class="btn btn-primary no-radius dropdown-toggle"><i class="fa fa-plus"></i> TAMBAH TRANSAKSI </a>
			<form role="form" action="<?php echo base_url(); ?>laporanTransaksiEksDir2/cetakdir2" method="POST" enctype="multipart/form-data"> 
			...
			<!--<a style="margin-bottom:3px" href="<?php echo base_url(); ?>LaporanTransaksiEksDir2/cetak_nota" target="_blank" class="btn btn-primary no-radius dropdown-toggle"><i class="fa fa-plus"></i> PRINT </a>-->
                 </div>  
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <!--  <td><?php echo $row['id_tr']; ?></td> -->
                      ...
                      <td>
                      <a class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>transaksii/edittransaksi/<?php echo $row['id_tr']; ?>"><i class="fa fa-pencil"></i></a>
                      <a onclick="return confirm('Hapus data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>transaksii/hapustransaksi/<?php echo $row['id_tr']; ?>"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
