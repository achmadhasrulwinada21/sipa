      ...
      <section class="content-header">
        <h1>
          <b>EDIT DATA URAIAN DIR VERSI II</b>
        </h1>
          <!-- <ol class="breadcrumb">
          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              <div class="box-header">
                ...
                <h3 class="box-title">EDIT DATA URAIAN DIR VERSI II</h3>
              </div>
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>uraiandir/updateuraiandir" method="POST" enctype="multipart/form-data">
                  <div class="col-lg-6">
                 ...
                 <div class="form-group">
                  ...
                  <a href="<?php echo base_url(); ?>uraiandir" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div><!-- /.col -->
