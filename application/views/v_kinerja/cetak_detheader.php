        ...
        display: table-header-group;
         ...
         <table style="margin-bottom:3px;margin-left: 7px;margin-top: 5px;">
                 ...
                 <br><br>
                  ...
                  <b style="margin-left:20px">Periode  : '.$periode.'</b><br>
                  ...
                  <thead>
                    <tr align="center" bgcolor="gray" style="color:white;font-weight:bold;">
                      ...
                      <th style="vertical-align: middle;text-align: center;">Nilat Target Harian</th>
                       <th style="vertical-align: middle;text-align: center;">Nilat Target Mingguan</th>
                        <th style="vertical-align: middle;text-align: center;">Nilat Target Bulanan</th>
                 ...
                 $html.=' <tr class="info">
                      ...
                      <td style="vertical-align: middle;text-align: center;width:110px;">'.$row['nama_uraiankrs'].'</td>
                       <td style="vertical-align: middle;text-align: center;">'.$row['nilai_target'].'</td>
                      <td style="vertical-align: middle;text-align: center;">'.(number_format($row['nilai_targeth'], 0,',','.')).'</td>
                      <td style="vertical-align: middle;text-align: center;">'.(number_format($row['nilai_targetm'], 0,',','.')).'</td>  
                      <td style="vertical-align: middle;text-align: center;">'.(number_format($row['nilai_targetb'], 0,',','.')).'</td>                 
                    </tr>';
                       }                          
                    $html.='         
                  </tbody>
