          ...
          <div class="row">
            <div class="col-md-12">
              <div class="clock">
                ...
                <a style="margin-bottom:3px" href="<?php echo base_url(); ?>C_realkinerja" class="btn btn-primary no-radius dropdown-toggle"><i class="glyphicon glyphicon-circle-arrow-left"></i> KEMBALI </a>
        ...
        <div class="table-responsive">
                <div class="box-body">
                 <table id="tb-datatables" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php $no=0; foreach($data_realkrs as $row) { $no++ ?>
                    ...
                    <tr>
                     ...
                     <td>
                     <a class="btn btn-warning btn-sm" data-toggle="modal"  data-target="#modal_edit<?php echo $row['id_realkrs'];?>"><i class="glyphicon glyphicon-edit"></i></a> 
                      <a onclick="return confirm('Hapus data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>C_realkinerja/hapusrealkrs/<?php echo $row['id_realkrs']; ?>"><i class="glyphicon glyphicon-trash"></i></a>
                     </td>
                    </tr>
                    <?php } ?>
