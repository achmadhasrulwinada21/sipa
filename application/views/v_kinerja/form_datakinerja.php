          ...
          <div class="row">
            <div class="col-md-12">
              <div class="clock">
                        ...
                        <br>
                        <br>
              <a style="margin-bottom:3px" href="<?php echo base_url(); ?>C_targetkinerja/addtargetkrs" class="btn btn-primary no-radius dropdown-toggle"><i class="glyphicon glyphicon-plus"></i> TAMBAH TARGET KINERJA </a>
        ...
        <div class="table-responsive">
                <div class="box-body">
                 <table id="tb-datatables" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php $no=0; foreach($data_target2krs as $row) { $no++ ?>
                    <tr>
                      <td><?php echo $no; ?></td>

                      <td><?php echo $row['periode']; ?></td>

                       <td><a href="<?php echo base_url(); ?>C_targetkinerja/tampil/<?php echo $row['periode']; ?>/<?php echo $row['kode_rs']; ?>"><button type="submit" class="btn btn-primary btn-block btn-flat"><?php echo $row['nama_rs']; ?></button></a></td>

                        <td style="vertical-align: middle;text-align: center;">
                        <a target="blank" class="btn btn-secondary btn-lg" href="<?php echo base_url(); ?>Cetak_laporankinerja/cetak_detheader/<?php echo $row['periode']; ?>/<?php echo $row['kode_rs']; ?>"><i class="fa fa-print"></i></a></td>

                       <td style="vertical-align: middle;text-align: center;">
                      <a  style="margin-bottom:3px;" onclick="return confirm('Hapus data beserta detail??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>C_targetkinerja/hapusdatatarget/<?php echo $row['periode']; ?>/<?php echo $row['kode_rs']; ?>"><i class="glyphicon glyphicon-remove"></i></a>
                     </td>
